...
<input type="button" name="bb1" id="bb1" value="ประกันภัยภาคบังคับ (พรบ.)" class="ui-button" onclick="location='car_insure_panel.php?id=<?php echo $_GET['id']; ?>'" disabled>
<input type="button" name="bb2" id="bb2" value="ประกันภัยภาคสมัครใจ" class="ui-button" onclick="location='car_insure_un_panel.php?id=<?php echo $_GET['id']; ?>'">
</div>
