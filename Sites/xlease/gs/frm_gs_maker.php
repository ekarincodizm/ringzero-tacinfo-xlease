...
<form name="frm_2" id="frm_2" method="post" action="frm_gs_maker_send.php">
<input type="hidden" name="comp" value="<?php echo "$gcoid"; ?>">
...
<?php
$qry=pg_query("SELECT * FROM gas.\"PoGas\" where status_approve = 'f' AND status_pay = 'f' AND status_po = 't' AND invoice is not null AND idcompany='$company' AND bill is null ORDER BY \"idno\",poid ASC ");
...
?>
        ...
        <td align="center"><a href="frm_gs_edit_po.php?id=<?php echo "$id"; ?>"><u>แก้ไข</u></a></td>
        <td align="center"><a href="frm_gs_cancel_po.php?id=<?php echo "$id"; ?>"><u>ยกเลิก</u></a></td>
    </tr>
<?php
}
...
?>
    <tr bgcolor="#FFFFFF">
        <td align="center" colspan="20"><br><input name="button" id="button" type="submit" value="Maker รายการที่เลือก"><br><br></td>
    </tr>
<?php    
}
?>
