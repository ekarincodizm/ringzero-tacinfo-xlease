...
<div align="center">
<?php
$in_sql="INSERT INTO \"GasCompany\" (coid,coname,model,cocost,price_tank,price_device,address,phone,memo) VALUES ('$id','$name','$model','$cost','$price_tank','$price_device','$address','$phone','$memo')";
...
<br><br>
<input type="button" value="  Back  " onclick="location.href='frm_typegas_add.php'">
</div>
