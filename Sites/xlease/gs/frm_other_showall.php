...
if( isset($mm) ){
        ...
        $qry_name=pg_query("SELECT * FROM carregis.\"CarTaxDue\" where EXTRACT(MONTH FROM \"ApointmentDate\")='$mm' AND EXTRACT(YEAR FROM \"ApointmentDate\")='$yy' AND (\"TypeDep\" is not null) ORDER BY \"IDNO\" ASC ");
