...
if( $res=pg_fetch_array($qry) ){
    ...
    $qry_com2=pg_query("select * from gas.\"Model\" where modelid='$idmodel' ");
    if( $res_com2=pg_fetch_array($qry_com2) ){
        $model=$res_com2["modelname"];
    }
...
$pdf->Image('../images/head_' . $_SESSION['session_company_code'] . '.jpg',10,3,190,29);

$pdf->SetFont('AngsanaNew','B',20);

/*
$pdf->SetXY(35,12);
$title=iconv('UTF-8','windows-874',"บริษัท $_SESSION[session_company_name]");
...
บริษัท $_SESSION[session_company_thainame]");
