...
if( isset($mm) and isset($yy) ){
        ...
        //$qry_name=pg_query("SELECT * FROM carregis.\"CarTaxDue\" where EXTRACT(MONTH FROM \"TaxDueDate\")='$mm' AND EXTRACT(YEAR FROM \"TaxDueDate\")='$yy' AND \"TaxValue\" is null ORDER BY \"IDNO\" ASC ");
...
?>
        ...
        <td align="center">
            <?php if($ApointmentDate == "-"){ ?>
                <a href="#" onclick="javascript:popU('frm_car_add.php?cid=<?php echo "$IDCarTax";?>','a1','toolbar=no,menubar=no,resizable=no,scrollbars=yes,status=no,location=no,width=800,height=600')"><img src="add.png" border="0" width="16" height="16" align="absmiddle"></a> 
            <?php }else if(!empty($TaxValue)){ ?>
                <img src="accept.png" border="0" width="16" height="16" align="absmiddle">
            <?php }else{ ?>
                <a href="#" onclick="javascript:popU('frm_car_edit.php?cid=<?php echo "$IDCarTax";?>','a2','toolbar=no,menubar=no,resizable=no,scrollbars=yes,status=no,location=no,width=800,height=600')"><img src="edit.png" border="0" width="16" height="16" align="absmiddle"></a>
            <?php } ?>
        </td>
    </tr>
 <?php
