...
<fieldset><legend><B>ใส่ใบเสร็จ</B></legend>
...
<?php
$qry=pg_query("SELECT * FROM gas.\"PoGas\" where idcompany='$company' AND bill is null AND status_approve = 't' 
ORDER BY \"idcompany\",\"idno\",poid ASC ");
...
?>
        <td align="center"><a href="frm_pay_bill_add.php?id=<?php echo "$id"; ?>"><u>ใส่ใบเสร็จ</u></a></td>
