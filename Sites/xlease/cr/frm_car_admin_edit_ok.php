...
<?php
    if(!empty($remark)){
        ...
        $in_sql="UPDATE carregis.\"CarTaxDue\" SET \"ApointmentDate\"='$apointmentdate',\"remark\"='$remark' WHERE \"IDCarTax\"='$cid' ";
    }else{
        $in_sql="UPDATE carregis.\"CarTaxDue\" SET \"ApointmentDate\"='$apointmentdate' WHERE \"IDCarTax\"='$cid' ";
    }
...
<br><br>
<input type="button" value="  Back  " onclick="location.href='frm_car_admin_mt.php'">
