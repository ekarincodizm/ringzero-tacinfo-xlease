...
<fieldset><legend><b>ใส่ข้อมูลการชำระค่าธรรมเนียม</b></legend>
...
?>
        ...
        <td align="center"><a href="#" onclick="javascript:popU('frm_car_pay_charge_add.php?cid=<?php echo "$IDCarTax";?>','a<?php echo $IDCarTax; ?>','toolbar=no,menubar=no,resizable=no,scrollbars=yes,status=no,location=no,width=800,height=600')"><img src="add.png" border="0" width="16" height="16" align="absmiddle" alt="เพิ่มค่าธรรมเนียม"></a> 
