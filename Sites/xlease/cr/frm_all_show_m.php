...
if( isset($mm) ){
         ...
         $qry_name=pg_query("select * from carregis.\"CarTaxDue\" where EXTRACT(MONTH FROM \"ApointmentDate\")='$mm' AND EXTRACT(YEAR FROM \"ApointmentDate\")='$yy' AND \"BookIn\"='true' ORDER BY \"IDNO\" ASC ");
