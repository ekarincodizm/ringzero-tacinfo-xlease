...
$sortby = pg_escape_string($_POST["sortby"]);
$month = pg_escape_string($_POST["month"]);
$monthshow = pg_escape_string($_POST["monthshow"]);
$year = pg_escape_string($_POST["year"]);
$year2 = pg_escape_string($_POST["year"]) + 543;
...
while($result_main=pg_fetch_array($query_main)){
	...
	$pdf->MultiCell(55,6,$buss_name,1,'L',0);
	...
	while($result=pg_fetch_array($query)){
		...
		$pdf->MultiCell(150,6,$buss_name,1,'R',0);
