...
$j = 0;                           
        ...
        where EXTRACT(MONTH FROM \"TaxDueDate\")='$m' AND EXTRACT(YEAR FROM \"TaxDueDate\")='$y' AND (\"TypeDep\"!='101' AND \"TypeDep\"!='105' AND \"TypeDep\"!='-1') ORDER BY \"IDNO\" ASC ");
...
$buss_name=iconv('UTF-8','windows-874',"ทั้งหมด $rows รายการ  รวมยอดเงิน : ".number_format($summary,2));
