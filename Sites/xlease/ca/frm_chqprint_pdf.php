...
$d_ncq=pg_query("select \"ReceiptDate\" 
                   from \"FCheque\" A
...
$qry_ncq=pg_query("select \"ChequeNo\",A.\"BankName\",A.\"BankName\",\"BankBranch\",\"DateOnCheque\",\"AmtOnCheque\"
                   from \"FCheque\" A
				   LEFT OUTER JOIN \"BankCheque\" B on B.\"BankCode\"=A.\"BankName\"
				   where \"PostID\" ='$recid' ");
...
$pdf->Text(30,40,$av_rdate); //Type่
 ...
 $qry_dtl=pg_query("select \"C_REGIS\",\"car_regis\",\"gas_number\",\"gas_name\",\"C_REGIS\",\"C_CARNUM\",\"C_CARNAME\",A.\"IDNO\",\"full_name\",\"TName\",\"CusAmount\"
 from \"DetailCheque\" A 
