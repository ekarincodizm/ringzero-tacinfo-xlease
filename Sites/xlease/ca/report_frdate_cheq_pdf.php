...
$pdf->SetXY(10,10);
$title=iconv('UTF-8','windows-874',"รายงาน ออกเช็คค่างวด");
...
$i = 1;
$j = 0;                           
$qry_fr=pg_query("select * from \"VFrEachDay\" WHERE (\"R_Prndate\"='$tday') AND (\"R_Bank\"='CU')  AND \"PayType\" = 'OC' ORDER BY \"R_Receipt\"");
