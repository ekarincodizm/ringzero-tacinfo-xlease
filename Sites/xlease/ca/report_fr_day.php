...
<div id="login"  style="height:50px; width:800px; text-align:left; margin-left:auto; margin-right:auto;">
  ...
  <form name="frm_recp" method="post" action="view_report_frdate.php" target="_blank">
    <p>VFrEachDay    
    <p>เลือกวันที่
      <input name="report_fr_Date" type="text" readonly="true"  value="<?php echo date("Y/m/d"); ?>"/>
      <input name="button" type="button" onclick="displayCalendar(document.frm_recp.report_fr_Date,'yyyy/mm/dd',this)" value="ปฏิทิน" />
