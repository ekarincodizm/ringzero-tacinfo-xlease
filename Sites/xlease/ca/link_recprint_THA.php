...
if($srid=="K")
{
  echo "ทำรายการเงินรับฝากแล้ว";
   echo "<input type=\"button\" name=\"close\" value=\"ปิดหน้านี้\" onClick=\"javascript:window.close();\">";
}
else
{
...
$srid=substr($trid,2,1);
 $qry=pg_query("select * from print_any_receipt('$trid')");
