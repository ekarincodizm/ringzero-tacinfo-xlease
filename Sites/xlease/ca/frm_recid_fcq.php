    ...
    <script type="text/javascript">        
        ...
        function findNames() {
            ...
            if (inputField.value.length > 0) {
                ...
                var url = "cq_listdata.php?names=" + inputField.value;                        
...
<div id="login"  style="height:50px; width:800px; text-align:left; margin-left:auto; margin-right:auto;">
  ...
  <form method="post" action="frm_chqprint_pdf.php">
    <p>เลขที่ post
      <input type="text" size="50" id="idno_names" name="idno_names" onKeyUp="findNames();" style="height:20;"  value=""/>
