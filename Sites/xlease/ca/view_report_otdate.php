...
while($res_fr=pg_fetch_array($qry_fq)){
    ...
    if($cancel == 'f'){
    $num++;
    $qry_ss=pg_query("select \"O_DATE\",\"O_BANK\",\"PayType\",\"IDNO\",\"full_name\",\"assetname\",\"TName\",\"regis\" from \"VFOtherpayEachDay\" WHERE (\"O_RECEIPT\"='$res_fr[O_RECEIPT]') ");
...
?>
    <tr>
        <td colspan="5" align="left" style="font-weight:bold;"><a href="report_otdate_pdf.php?type=1&tday=<?php echo $tday; ?>" target="_blank"><img src="icoPrint.png" border="0" width="17" height="14" alt=""> สั่งพิมพ์</a></td>
...
while($res_fr=pg_fetch_array($qry_fq)){
    ...
    $qry_cl=pg_query("select \"Cancel\" from \"FOtherpay\" WHERE (\"O_RECEIPT\"='$res_fr[O_RECEIPT]') ");
    $res_cl=pg_fetch_array($qry_cl);
    $cancel = $res_cl["Cancel"];
...
?>
    <tr>
        <td colspan="5" align="left" style="font-weight:bold;"><a href="report_otdate_pdf.php?type=2&tday=<?php echo $tday; ?>" target="_blank"><img src="icoPrint.png" border="0" width="17" height="14" alt=""> สั่งพิมพ์</a></td>
        <td colspan="6" align="right" style="font-weight:bold;">ทั้งหมด <?php echo $n; ?> รายการ | รวมเฉพาะค่าวิทยุ <?php echo number_format($sum_wall,2); ?> | รวมยอดเงิน <?php echo number_format($summary,2); ?></td>
    </tr>
<?php
}
...
while($res_fr=pg_fetch_array($qry_fq)){
    ...
    $qry_ss=pg_query("select \"O_DATE\",\"O_BANK\",\"IDNO\",\"full_name\",\"assetname\",\"TName\",\"regis\"  from \"VFOtherpayEachDay\" WHERE (\"O_RECEIPT\"='$res_fr[O_RECEIPT]') ");
    $res_ss=pg_fetch_array($qry_ss);
...
?>
    <tr>
        <td colspan="5" align="left" style="font-weight:bold;"><a href="report_otdate_pdf.php?type=3&tday=<?php echo $tday; ?>" target="_blank"><img src="icoPrint.png" border="0" width="17" height="14" alt=""> สั่งพิมพ์</a></td>
        <td colspan="6" align="right" style="font-weight:bold;">ทั้งหมด <?php echo $n; ?> รายการ | รวมเฉพาะค่าวิทยุ <?php echo number_format($sum_wall,2); ?> | รวมยอดเงิน <?php echo number_format($summary,2); ?></td>
    </tr>
<?php
}
...
?>
    <tr>
        <td colspan="5" align="left" style="font-weight:bold;"><a href="report_otdate_pdf.php?type=4&tday=<?php echo $tday; ?>" target="_blank"><img src="icoPrint.png" border="0" width="17" height="14" alt=""> สั่งพิมพ์</a></td>
...
<table width="100%" border="0" cellSpacing="1" cellPadding="3" align="center" bgcolor="#F0F0F0">
    <tr bgcolor="#FFFFFF">
        <td colspan="12" align="left" style="font-weight:bold;">รายงาน ยกเลิกใบเสร็จ ประจำวันที่ <?php echo "$restrn"; ?></td>
    </tr>
    <tr style="font-weight:bold;" valign="middle" bgcolor="#79BCFF">
        <td align="center">No.</td>
...
?>
    <tr>
        ...
        <td align="right" colspan="8" style="font-weight:bold;">
			<u>รวมอนุมัติแล้ว</u> <?php echo number_format($sum_1,2); ?> | <u>รวมยังไม่อนุมัติ</u> <?php echo number_format($sum_2,2); ?>
		</td>
    </tr>
	<tr>
