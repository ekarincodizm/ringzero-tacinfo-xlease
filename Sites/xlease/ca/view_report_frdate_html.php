...
$_SESSION["av_iduser"];
$tday=pg_escape_string($_GET["report_fr_Date"]);
...
?>
    <tr>
        <td colspan="9" align="left" style="font-weight:bold;">ทั้งหมด <?php echo $n; ?> รายการ</td>
...
?>
    <tr>
        <td colspan="6" align="left" style="font-weight:bold;">ทั้งหมด <?php echo $n; ?> รายการ</td>
