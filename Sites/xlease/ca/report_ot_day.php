...
<div id="login"  style="height:50px; width:800px; text-align:left; margin-left:auto; margin-right:auto;">
  ...
  <form name="frm_recp" method="post" action="view_report_otdate.php" target="_blank">
    <p>VFOtherpayEachDay
    <p>เลือกวันที่
      <input name="report_ot_Date" type="text" readonly="true"  value="<?php echo date("Y/m/d"); ?>"/>
      <input name="button" type="button" onclick="displayCalendar(document.frm_recp.report_ot_Date,'yyyy/mm/dd',this)" value="ปฏิทิน" />
