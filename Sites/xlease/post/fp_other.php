	...
	//-----
	   ...
	   function initVarss() {
        ...
        function callbacks() {
			...
			document.frm_input.f_band.disabled = false;
			document.frm_input.f_band.value='TOYOTA COROLLA/';		
        ...
        function populateNames(cells) {
			...
			document.frm_input.f_band.disabled = true;
			document.frm_input.f_band.value='ใช้ข้อมูลที่เลือก';	
...
<div id="login"  style="height:50px; width:800px; text-align:left; margin-left:auto; margin-right:auto;">
  <div class="style3" style="background-color:#333333; width:auto; height:20px; padding-left:10px;">ทำรายการลูกค้านอก <?php echo $_SESSION["session_company_name"]; ?></div>
  <div class="style3" style="background-color:#000000; width:auto; height:20px; padding-left:10px;"></div>
  <div class="style5" style="width:auto; height:40px; padding-left:10px;"><br />
  </div>
  <form method="post" action="save_fp_cash.php" name="frm_input" onsubmit="return validate(this);" >
  ...
  <tr>
    <td colspan="3" style="background-color:#FFFFCC;">รายละเอียดลูกค้านอก</td>
    </tr>
	  <tr>
    <td colspan="3" style="background-color:#C7ECFA;">ตรวจสอบชื่อ<br />
      <input type="text" size="60" id="txtnames" name="txtnames" onkeyup="findNames();" style="height:20;" tabindex="1"/>
   ...
   <div style="visibility:hidden;" id="popup" name="popup"></div>	  </td>
    </tr>

  <tr>
    <td>คำนำหน้า</td>
    <td><input type="hidden" name="sta_cusid" id="sta_cusid" value="0"/><input type="text" name="f_firname"  /></td>
    <td><input type="hidden" name="s_val" onkeyup="findNames();"  /></td>
  </tr>
  <tr>
    <td>ชื่อ</td>
  ...
  <tr>
    ...
    <td colspan="3" style="background-color:#B8D8C8">ตรวจสอบเลขตัวถัง หรือ เลขทะเบียน<br />
      <input type="text" size="60" id="txtnamess" name="txtnamess" onkeyup="findNamess();" style="height:20;"/>
  ...
  <tr>
    <td>ยี่ห้อ/รุ่น</td>
    <td><input type="text" name="f_band" value="TOYOTA COROLLA/"  /></td>
    <td></td>
  </tr>
  <tr>
    <td>สี</td>
