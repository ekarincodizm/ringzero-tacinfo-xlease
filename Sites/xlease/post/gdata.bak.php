...
while($res_cn=pg_fetch_array($sql_select)){
   ...
   if($res_cn["LockContact"]=='t'){
        ...
        echo "<li onselect=\"this.setText('$IDNO : $C_REGIS - $A_NAME - $C_CARNUM - $TranIDRef1 - $TranIDRef2').setValue('$IDNO'); \">$display_IDNO $slock : $display_C_REGIS - $display_A_NAME - $display_C_CARNUM - $TranIDRef1 - $TranIDRef2</li>";
}
?>