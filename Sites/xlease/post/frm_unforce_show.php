...
<div class="title_top">ประกันภัยภาคสมัครใจ</div>
...
<?php
$get_insfidno = array();
$qry_ac=pg_query("select \"InsUFIDNO\" from \"insure\".\"InsureUnforce\" WHERE \"IDNO\"='$idno' ORDER BY \"InsUFIDNO\" ASC");
while($res_ac=pg_fetch_array($qry_ac)){
    $get_insfidno[] = $res_ac["InsUFIDNO"]; 
}
...
if(!empty($insfid)){
    ...
    WHERE A.\"IDNO\"='$idno' AND A.\"InsUFIDNO\"='$insfid' ");
}else{
    $qry_dc=pg_query("select A.*,B.* from \"insure\".\"InsureUnforce\" A 
    LEFT OUTER JOIN \"VContact\" B ON A.\"IDNO\"=B.\"IDNO\" 
    WHERE A.\"IDNO\"='$idno' AND A.\"InsUFIDNO\"='$get_insfidno[$number_index]' ");
}
...
$outins=pg_query("select \"insure\".outstanding_insureunforce('$InsUFIDNO')");
...
<?php
if($tt1>=0){
    echo "<a href=\"frm_unforce_show.php?idno=$idno&insfid=$get_insfidno[0]\"> <b>&lt;&lt;</b> </a>";
    echo "<a href=\"frm_unforce_show.php?idno=$idno&insfid=$get_insfidno[$tt1]\"> <b>&lt;</b> </a>";
}
if(!empty($insfid)){
    echo " <i>$insfid</i> ";
}else{
...
if($tt2<=$num_arrays_lob){
    echo "<a href=\"frm_unforce_show.php?idno=$idno&insfid=$get_insfidno[$tt2]\"> <b>&gt;</b> </a>";
    echo "<a href=\"frm_unforce_show.php?idno=$idno&insfid=$get_insfidno[$num_arrays_lob]\"> <b>&gt;&gt;</b> </a>"; 
}
?>
</div>
...
<table width="100%" border="0" cellSpacing="0" cellPadding="5" align="left">
    ...
    <tr align="left">
        ...
        <td><a href="../up/frm_show.php?id=<?php echo $InsUFIDNO; ?>&type=insuf&mode=1" target="_blank"><u><?php echo $InsUFIDNO; ?></u></a></td>
...
$qry_vcus=pg_query("select \"O_DATE\",\"O_RECEIPT\",\"O_MONEY\",\"PayType\" from \"FOtherpay\" WHERE  \"RefAnyID\"='$InsUFIDNO' AND \"O_Type\"='102' AND \"Cancel\"='false' order by \"O_DATE\"  ");
