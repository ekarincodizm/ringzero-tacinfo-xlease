...
<div id="login"  style="height:50px; width:800px; text-align:left; margin-left:auto; margin-right:auto;">
  ...
  <tr>
    <td>จำนวนงวด</td>
    <td><input name="count_payment" type="text" onkeyup="calcfunc()" value="0" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>ค่างวด</td>
    <td><input name="price_payment" type="text" onkeyup="calcfunc()" value="0" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>วันที่งวดแรก</td>
  ...
  <tr>
    ...
    <td><input name="first_price" type="text" onkeyup="calcfunc()"/></td>
    <td>(ค่างวด x จำนวนงวด 
      <input type="text" name="resbs" style="background-color:#FFFFCC; border:thin; text-align:center;" /> 
      ) </td>
  </tr>
  <tr>
    <td>เงินต้นทางบัญชี</td>
    <td><input name="acc_first_price" type="text" onkeyup="calcfunc()" /></td>
    <td></td>
  </tr>
  <tr>
    <td>ซื้อมาจาก</td>
