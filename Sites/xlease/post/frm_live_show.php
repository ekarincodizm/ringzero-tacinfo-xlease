...
<div class="title_top">ประกันภัยคุ้มครองหนี้</div>
...
<?php
$get_insfidno = array();
$qry_ac=pg_query("select \"InsLIDNO\" from \"insure\".\"InsureLive\" WHERE \"IDNO\"='$idno' ORDER BY \"InsLIDNO\" ASC");
while($res_ac=pg_fetch_array($qry_ac)){
    $get_insfidno[] = $res_ac["InsLIDNO"]; 
}
...
if(!empty($insfid)){
    $qry_dc=pg_query("select A.*,B.* from \"insure\".\"InsureLive\" A 
    LEFT OUTER JOIN \"VContact\" B ON A.\"IDNO\"=B.\"IDNO\" 
    WHERE A.\"IDNO\"='$idno' AND A.\"InsLIDNO\"='$insfid' ");
}else{
    $qry_dc=pg_query("select A.*,B.* from \"insure\".\"InsureLive\" A 
    LEFT OUTER JOIN \"VContact\" B ON A.\"IDNO\"=B.\"IDNO\" 
    WHERE A.\"IDNO\"='$idno' AND A.\"InsLIDNO\"='$get_insfidno[$number_index]' ");
}
...
if($res_if=pg_fetch_array($qry_dc)){
	...
	$InsDate = $res_if["InsDate"];
}

$outins=pg_query("select \"insure\".outstanding_insurelive('$InsLIDNO')");
...
<?php
if($tt1>=0){
    echo "<a href=\"frm_live_show.php?idno=$idno&insfid=$get_insfidno[0]\"> <b>&lt;&lt;</b> </a>";
    echo "<a href=\"frm_live_show.php?idno=$idno&insfid=$get_insfidno[$tt1]\"> <b>&lt;</b> </a>";
}
if(!empty($insfid)){
    echo " <i>$insfid</i> ";
}else{
...
if($tt2<=$num_arrays_lob){
    echo "<a href=\"frm_live_show.php?idno=$idno&insfid=$get_insfidno[$tt2]\"> <b>&gt;</b> </a>";
    echo "<a href=\"frm_live_show.php?idno=$idno&insfid=$get_insfidno[$num_arrays_lob]\"> <b>&gt;&gt;</b> </a>"; 
}
?>
</div>
...
<table width="100%" border="0" cellSpacing="0" cellPadding="5" align="left">
    ...
    <tr align="left">
        <td><b>รหัสประกันภัย</b></td>
        <td><a href="../up/frm_show.php?id=<?php echo $InsLIDNO; ?>&type=insuf&mode=1" target="_blank"><u><?php echo $InsLIDNO; ?></u></a></td>
    ...
    <tr align="left">
        ...
        <td><b>ทุนประกัน</b></td>
        <td><?php echo number_format($Invest,2); ?> <span class="text_gray">บาท.</span></td>
    </tr>
    <tr align="left">
...
<?php
//หา type ของประกันภัยคุ้มครองหนี้
$typeID=pg_getinsurelivetype();
$qry_vcus=pg_query("select \"O_DATE\",\"O_RECEIPT\",\"O_MONEY\",\"PayType\" from \"FOtherpay\" WHERE  \"RefAnyID\"='$InsLIDNO' AND \"O_Type\"='$typeID' AND \"Cancel\"='false' order by \"O_DATE\"  ");
