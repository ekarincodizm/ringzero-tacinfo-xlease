...
function chklist(){
	...
	if (document.frm_1.g_down.value=="") {
		theMessage = theMessage + "\n -->  กรุณาใส่เงินดาวน์";
	}
	if (document.frm_1.g_total.value=="") {
		theMessage = theMessage + "\n -->  กรุณาใส่จำนวนงวด";
	}
	if (document.frm_1.g_month.value=="") {
		theMessage = theMessage + "\n -->  กรุณาระบุค่างวด";
	}
	if (document.frm_1.g_begin.value=="") {
		theMessage = theMessage + "\n -->  กรุณาใส่เงินต้นลูกค้า";
	}
	if (document.frm_1.g_beginx.value=="") {
...
<fieldset><legend><B>สัญญาแก๊ส - ผ่อนชำระ</B></legend>

<form name="frm_1" method="post" action="save_gas.php">
...
<tr>
    ...
    <tr>
		...
		<tr>
			<td>เลขไมล์ </td>
			<td colspan="2"><input type="text" name="C_Milage" size="7px;" onkeypress="check_number(event)"/> กิโลเมตร</td>
		</tr>
		<tr>
	...
	<tr>
      <td>ประเภทแก๊ส </td>
      <td>
		<select name="g_type" onchange="passrq(this);">
    ...
    <tr>
      <td>เงินดาวน์</td>
      <td><input type="text" name="g_down" size="30" onkeypress="return check_number(event);" onkeyup="passrq(this);"/><font color="red">*</font></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>จำนวนงวด</td>
      <td><input type="text" name="g_total" size="30" onkeypress="return check_number(event);" onkeyup="passrq(this);"/><font color="red">*</font></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>ค่างวด</td>
      <td><input type="text" name="g_month" size="30" onkeypress="return check_number(event);" onkeyup="passrq(this);"/><font color="red">*</font></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td> 
    </tr>
    <tr>
      <td>เงินต้นลูกค้า</td>
      <td><input type="text" name="g_begin" size="30" onkeypress="return check_number(event);" onkeyup="passrq(this);"/><font color="red">*</font></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>เงินต้นทางบัญชี</td>
      <td><input type="text" name="g_beginx" size="30" onkeypress="return check_number(event);" onkeyup="passrq(this);"/><font color="red">*</font></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>วันที่จ่ายงวดแรก</td>
      <td><input name="f_Date" type="text"  size="12" readonly="readonly" value="<?php echo date("Y/m/d"); ?>"/>
        <input name="button2" type="button" onclick="displayCalendar(document.frm_1.f_Date,'yyyy/mm/dd',this)" value="ปฏิทิน" /></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
...
function chkrq(){
	...
	if (document.frm_1.g_type.value=="") {
		document.frm_1.g_type.style.backgroundColor="#FFCCCC";
	}
	if (document.frm_1.g_name.value=="") {
	...
	if (document.frm_1.g_down.value=="") {
		document.frm_1.g_down.style.backgroundColor="#FFCCCC";
	}
	if (document.frm_1.g_total.value=="") {
		document.frm_1.g_total.style.backgroundColor="#FFCCCC";
	}
	if (document.frm_1.g_month.value=="") {
		document.frm_1.g_month.style.backgroundColor="#FFCCCC";
	}
	if (document.frm_1.g_begin.value=="") {
		document.frm_1.g_begin.style.backgroundColor="#FFCCCC";
	}
	if (document.frm_1.g_beginx.value=="") {
		document.frm_1.g_beginx.style.backgroundColor="#FFCCCC";
	}
