...
if($c_month == '2') {  $s_c= "กุมพาพันธ์"; } else
...
$pdf->Text(117,162+$arow,$car_c_mar);//เลขเครื่อง
...
$pdf->Text(165,228.5+$mrow,$gas_cost);//ราคาเช่าซื้อ




$gas_vatcost=iconv('UTF-8','windows-874',number_format($vat_bath,2));
$pdf->Text(59,236+$mrow,$gas_vatcost);//vat ทั้งหมด

$gas_totalcost=iconv('UTF-8','windows-874',number_format($cost_total,2));
$pdf->Text(139,236+$mrow,$gas_totalcost);//ยอดทั้งหมด
...
$pdf->Text(41,281.5+$mrow,$gas_fsdate);//รวม งวดผ่อน
