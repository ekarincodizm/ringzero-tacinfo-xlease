...
<div id="login"  style="height:50px; width:800px; text-align:left; margin-left:auto; margin-right:auto;">
  ...
  <div style="font-weight:bold;color:red;font-size:13pt;text-align:center;padding:0 0 10px;">
  *** หากไม่มีข้อมูลแสดง หรือข้อมูลไม่ถูกต้อง ในส่วนของลูกค้า <br>
  โปรดตรวจสอบว่าข้อมูลของลูกค้าคนนั้นๆ มีข้อมูลที่หายไปครบถ้วนหรือไม่ ***</div>
  <form method="post" action="../report/frm_rpt_ck.php" target="_blank">
  ตรวจสอบ IDNO
