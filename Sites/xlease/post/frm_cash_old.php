...
<div id="login"  style="height:50px; width:800px; text-align:left; margin-left:auto; margin-right:auto;">
  ...
  <tr>
    ...
    <td><input type="text" name="f_idcard"  /></td>
    <td>&nbsp;</td>
  </tr>
 	 <tr>
  ...
  <tr>
    <td>ปีรถ (ค.ศ.)</td>
    <td><input type="text" name="f_yearcar" /></td>
    <td>&nbsp;</td>
  </tr>
 <tr>
    <td>รหัสวิทยุ</td>
  ...
  <tr>
    ...
    <td><!--<input type="reset" value="เริ่มใหม่ทั้งหมด"   />--><input type="button" value="เริ่มใหม่ทั้งหมด" onclick="window.location='frm_cash.php'">
