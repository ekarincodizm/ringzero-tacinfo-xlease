...
<div id="login"  style="height:50px; width:800px; text-align:left; margin-left:auto; margin-right:auto;">
  ...
  <div class="style5" style="width:auto; height:20px; padding-left:10px;">LETTER &nbsp;&nbsp;&nbsp;<a href="../list_menu.php"></a><br />
    ...
    <div class="style5" style="width:auto; height:20px; padding-left:10px;"><a href="frm_letter.php">[ทำรายการส่งจดหมาย]</a><a href="frm_report_letter.php"> [รายงานส่งจดหมาย]</a> <a href="frm_edit_letter.php">[แก้ไขที่อยู่]</a><a href="" onclick="window.close()"> [ปิดหน้านี้]</a><br />
  </div>
  <div class="style5" style="width:auto; height:100px; padding-left:0px;">
  <div style="padding-left:10px;"><form id="form1" name="form1" method="post" action="frm_dtl_select.php">
