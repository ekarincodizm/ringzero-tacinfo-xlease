...
$(document).ready(function(){
    ...
    $('#btn1').click(function(){
        $("#panel").load("frm_edit.php?auto_id="+ $("#auto_id").val());
    });
...
<input type="button" value="แก้ไขรูปแบบจดหมาย" onclick="window.location='frm_edit_type_letter.php'" disabled>
<input type="button" value="ลบรูปแบบจดหมาย" onclick="window.location='frm_delete_type_letter.php'">
</div>
<div style="float:right"><input type="button" value="  Close  " onclick="javascript:window.close();"></div>
<div style="clear:both; padding-bottom: 10px;"></div>

<fieldset><legend><B>แก้ไขรูปแบบจดหมาย</B></legend>
