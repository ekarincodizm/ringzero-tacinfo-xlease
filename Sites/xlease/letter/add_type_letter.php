...
<input type="button" value="กลับ" onclick="window.location='frm_type_letter.php'">
</div>
<div style="float:right"><input type="button" value="  Close  " onclick="javascript:window.close();"></div>
<div style="clear:both; padding-bottom: 10px;"></div>

<fieldset><legend><B>เพิ่มประเภทของรูปแบบจดหมาย</B></legend>
...
<table cellSpacing="1" cellPadding="3" border="0" bgcolor="#F0F0F0" align="center" width="80%">
	<tr>
		...
		<td bgcolor="#FFFFFF"><input type="text" name="type_name" id="type_name" size="60"><input type="hidden" name="method" value="add"></td>
	</tr>
	<tr>
		<td align="right" bgcolor="#D5EFFD"><b>สถานะการใช้งาน :</b></td>
		<td bgcolor="#FFFFFF">
			<select name="is_use">
				<option value="TRUE">อนุญาตให้ใช้</option>
				<!--<option value="FALSE">ไม่อนุญาตให้ใช้</option>-->
			</select>
		</td>
	</tr>
</table>
