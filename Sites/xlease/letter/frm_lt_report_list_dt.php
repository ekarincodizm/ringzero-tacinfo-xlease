...
<?php
$qry_name2=pg_query("select \"auto_id\",\"send_date\",\"IDNO\",A.\"address_id\",\"detail\",\"type_send\",\"userid\",
\"coname\",\"A_FIRNAME\",\"A_NAME\",\"A_SIRNAME\",\"address\" from letter.\"SendDetail\" A 
left join letter.\"cus_address\" B on A.\"address_id\" = B.\"address_id\"  
left join \"Fa1\" C on B.\"CusID\" = C.\"CusID\"
WHERE A.\"IDNO\"='$dt' and A.\"send_date\" is not null order by A.\"send_date\" DESC");
