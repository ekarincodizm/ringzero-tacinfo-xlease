...
<table width="100%" border="0" cellSpacing="1" cellPadding="3" align="center" bgcolor="#F0F0F0">
		<tr bgcolor="#FFFFFF">
			<td colspan="12" align="left" style="font-weight:bold;">ประวัติการอนุมัติอนุมัติยกเลิกงานระหว่างยึด 30 รายการล่าสุด  <input type="button" value="แสดงประวัติทั้งหมด" onclick="javascript:popU('frm_history_all.php','','toolbar=no,menubar=no,resizable=no,scrollbars=yes,status=no,location=no,width=1400,height=650')" style="cursor:pointer;"></td>
		</tr>
		...
		<?php
		$query = pg_query("select *   from \"nw_seize_cancel_btseizure\" where \"status\" <> '9' order by \"approvestamp\" desc limit 30");
		$i=0;
