...
<title>Script Update ประวัติแก้ไขข้อมูลลูกค้า</title>
<script language=javascript>
$(document).ready(function(){
	$('#btn1').click(function(){
		$("#btn1").attr('disabled',true);
		$("#panel").text('กำลังดำเนินการ...ระบบอาจจะใช้เวลาประมวลผลนาน 5-10 นาที');
		$("#panel").load("process_update.php");
...
<body>
<div  align="center"><h1>Update ประวัติแก้ไขข้อมูลลูกค้าเกี่ยวกับผู้อนุมัติและวันเวลาที่อนุมัติให้เป็น NULL</h1></div>
