...
<fieldset><legend><B>ทำรายการใบสำคัญรับ</B></legend>
...
<?php
	...
	if($chk_insert_channel!="on"){
		...
		values ('$date_add','$this_time','$user_id','$add_date',null,'$f_name',$text_add,'2','9','$arrayaccbookserial','$arraybooktype','$arrayabd_amount',
		$voucherPurpose,'0')
		...
		if(!$result=pg_query($in_sql)){
			...
			$check_insert = pg_fetch_result($result,0);
			if($check_insert == ""){$status++;}		
