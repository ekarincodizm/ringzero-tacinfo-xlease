...
$voucherPurposetype="RV";
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.1//EN" "http://www.w3.org/TR/xhtml11/DTD/xhtml11.dtd">
<html>
<head>
    <!--<title><?php echo $_SESSION["session_company_name"]; ?></title>-->
	<title>(THCAP) ทำรายการใบสำคัญรับ</title>
...
$(document).ready(function(){
	...
	$("#topayfullin").hide();
     ...
     $("#formula").autocomplete({
			source: "../thcap_add_paymentpvoucher/s_bookall.php",
			minLength:1
	});
      ...
      function doCallAjax() {	
		...
		HttPRequest = false;
          ...
          if (!HttPRequest) {
            ...
            var url = '../thcap_add_paymentpvoucher/ajax_query.php';           
...
<body>
<div class="header"><h1>(THCAP) ทำรายการใบสำคัญรับ</h1></div>
...
<fieldset><legend><B>ทำรายการ- Receive Voucher</B></legend>
...
<form method="post" name="add_acc" id="add_acc" action="process_add_receivevoucher.php">
...
<?php 
	...
	$sendfrom='1';
	include('../thcap_appv_rv/frm_rv_wait.php');
