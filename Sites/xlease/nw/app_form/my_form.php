<?php
	...
	function page_navigator($before_p,$plus_p,$total,$total_p,$chk_page){   
		global $e_page;
		global $querystr;
		$urlfile="my_form.php"; // ส่วนของไฟล์เรียกใช้งาน ด้วย ajax (ajax_dat.php)
		$per_page=10;
...
<div align="center">
	...
	<div class="container">
    	<div class="title"><h1>แบบฟอร์มทั้งหมด</h1></div>
        <div class="content">
        	<ul class="list">
                ...
                <?php
					...
					$q = "select \"formID\",\"company_name\",\"doer\",\"doer_time\",\"form_state\" from $schema.\"app_frm\" where \"doer\"='$userid' order by \"formID\" desc";
					$qr = pg_query($q);
					...
					while($rs = pg_fetch_array($qr))
					{
						...
						$i++;
						echo "<div class=\"name left inline\"><a class=\"link\" href=\"show_form_user.php?id=$id\">$title</a></div>";
						...
						echo "<div class=\"form center inline\"><span class=\"orange_botton\" onclick=\"window.location.href='show_form.php?id=$id'\">แสดง</span></div>";
						echo "</li>";
					}
				?>
            </ul>
