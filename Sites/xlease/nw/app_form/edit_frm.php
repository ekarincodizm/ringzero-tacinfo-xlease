...
<div align="center">
	...
	<div class="container">
    <form method="post" name="app_form" id="app_form" action="edit_process.php?id=<?php echo $id; ?>" enctype="multipart/form-data">
        ...
        <div class="row">
        	<div class="box" id="block6">
                <div class="row center gray bold medium">ตอบคำถาม</div>
                <div class="input">
        ...
        <div class="bottom_form">
        	<span class="btn reply" onclick="window.location.href = 'home.php';">กลับ</span>
...
$(document).ready(function(){
	$('#date,#commencement_date,#ied,#dofi').datepicker();
