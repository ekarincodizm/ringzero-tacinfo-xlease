...
// หาข้อมูลการยึด
$qry_data = pg_query("select \"createID\", \"assetDetailID\", \"seizeStatus\", \"seizeDate\", \"doerID\", \"doerStamp\", \"doerNote\"
						from \"thcap_seize_asset\" where \"seizeID\" = '$seizeID' ");
...
$seizeDate = pg_fetch_result($qry_data,3); // วันที่ยึดสินทรัพย์เข้าบริษัท
$doerID = pg_fetch_result($qry_data,4); // ผู้บันทึกยึด
$doerStamp = pg_fetch_result($qry_data,5); // วันเวลาที่บันทึกยึด
$doerNote = pg_fetch_result($qry_data,6); // หมายเหตุการบันทึกยึดสินทรัพย์
...
<center>
	<h2>(THCAP) ตรวจสอบรับทรัพย์สินรับคืน-ยึดคืน</h2>
	<form method="post" name='myfrm' action="process_appv_record_seize_asset.php">
		...
		<table width="100%" align="center" border="0" cellspacing="1" cellpadding="1" bgcolor="#FFECEC">
			<tr>
				...
				<td width="50%" align="left"><?php echo $seizeDate; ?></td>
			</tr>
			<tr>
				<td width="50%" align="right"><b>ผู้บันทึกยึด : </b></td>
				<td width="50%" align="left"><?php echo $fullname; ?></td>
			</tr>
			<tr>
				<td width="50%" align="right"><b>วันเวลาที่บันทึกยึด : </b></td>
				<td width="50%" align="left"><?php echo $doerStamp; ?></td>
			</tr>
			<tr>
				<td width="50%" align="right"><b>หมายเหตุ การบันทึกยึด : </b></td>
				<td width="50%" align="left"><textarea cols="45" rows="4" style="background-color:#CCCCCC;" readOnly><?php echo $doerNote; ?></textarea></td>
			</tr>
			<tr>
