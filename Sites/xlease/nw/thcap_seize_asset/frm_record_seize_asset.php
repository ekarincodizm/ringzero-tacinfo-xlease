...
<tr>
	<td>
		<div class="header"><h1>(THCAP) บันทึกรับทรัพย์สินรับคืน-ยึดคืน</h1></div>
		<div class="wrapper">
			<table width="100%" border="0" cellSpacing="1" cellPadding="3" align="center" bgcolor="#F0F0F0">
				...
				<?php
				$qry_create = pg_query("select a.\"seizeID\", a.\"createID\", a.\"assetDetailID\", a.\"seizeStatus\", b.\"contractID\"
										from \"thcap_seize_asset\" a, \"thcap_create_seize_asset\" b
										where a.\"createID\" = b.\"createID\"
										and a.\"seizeStatus\" = '9'
										order by b.\"contractID\", a.\"assetDetailID\" ");
				...
				?>
						...
						<td align="center"><img src="../thcap/images/save.png" onClick="popU('popup_record_seize_asset.php?seizeID=<?php echo $seizeID; ?>','','toolbar=no,menubar=no,resizable=no,scrollbars=yes,status=no,location=no,width=1100,height=700');" style="cursor:pointer;"></td>
				<?php
					echo "</tr>";
				} //end while
				if($nub == 0){
