...
$qry_contract = pg_query("select * from thcap_check_leasing_gen_effectivetable_data order by \"contractID\" ");
...
<div align="center" >
	...
	<h3>ตรวจสอบการสร้างตารางลดต้นลดดอกของสัญญาเช่า และเช่าซื้อ และตั๋วเงิน</h3>
		...
		<?php
			$i = 0;			
				while($result_contract = pg_fetch_array($qry_contract))
				{
					...
					$buutonEIR = "<input type=\"button\" value=\"Generate EIR\" onclick=\"javascript:popU('popup_10.php?conID=".$result_contract["contractID"]."','','toolbar=no,menubar=no,resizable=no,scrollbars=yes,status=no,location=no,width=600,height=350')\">";
					...
					echo "<td align=\"center\">".$buutonEIR."</td>";
					echo "<tr>";
				}
			echo "<tr bgcolor=\"#CDC5BF\"><td colspan=\"4\">รวม $rows_contract รายการ</td></tr>";
		?>
	</table>
</div>
</body>
