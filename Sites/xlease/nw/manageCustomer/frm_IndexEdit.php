...
<div id="wmax" style="width:100%; height:100%; border:#666666 solid 0px; margin-top:0px;">
	...
	<div id="login"  style="height:50px; width:800px; text-align:left; margin-left:auto; margin-right:auto;">
		...
		<div class="style5" style="width:auto; padding:10px;"><b>แก้ไขข้อมูลลูกค้า</b></div>
		<form method="post" action="frm_Edit.php">
			ค้นหาชื่อ, นามสกุล, บัตรประชาชน, รหัสลูกค้า :
			<input type="text" size="70" id="CusID" name="CusID" style="height:20;"/>
