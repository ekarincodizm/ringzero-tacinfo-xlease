...
<div id="wmax" style="width:100%; height:100%; border:#666666 solid 0px; margin-top:0px;">
	...
	<div id="warppage"  style="width:800px; text-align:left; margin-left:auto; margin-right:auto;"><b>แสดงข้อมูลลูกค้า</b> <br /><hr />
		...
		<tr>
			<td>ประเทศ</td>
			<td><input type="text" value="<?php echo $fa1_country; ?>" readonly="true" readonly="true">
			</td>
