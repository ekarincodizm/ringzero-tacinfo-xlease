    ...
    <tr>
        <td>
			...
			<div class="wrapper">
				...
				<fieldset><legend><B>เงื่อนไขในการสรุปผลการชักชวนและจับคู่</B></legend>
					<form method="post" name="form1" action="summary_InviteMatch2.php">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:20px" align="center">
						<tr>
							<td height="30" width="150"></td>
							<td><input type="radio" name="con_invitecompare" value="1" checked> ประจำสัปดาห์ ของเดือน
								<select name="m_1">
						...
						<tr>
							<td height="30"></td>
							<td><input type="radio" name="con_invitecompare" value="2"> ประจำเดือน
								<select name="m_2">
									<option value="01">มกราคม</option>
									<option value="02">กุมภาพันธ์</option>
									<option value="03">มีนาคม</option>
						...
						<tr>
							<td height="30"></td>
							<td><input type="radio" name="con_invitecompare" value="3"> ประจำไตรมาส
								<select name="m_3">
						...
						<tr>
							<td height="30"></td>
							<td><input type="radio" name="con_invitecompare" value="4">ประจำปี ค.ศ.
								<select name="y_4">
									<option value="2011">2011</option>
									<option value="2012">2012</option>
									<option value="2013">2013</option>
						...
						<tr><td colspan="2" height="50" align="center"><input type="submit" value=" ค้นหา "></td></tr>
					</table>
					</form>
				</fieldset>
			</div>
