...
$(document).ready(function(){
    $('#btn00').click(function(){
        ...
        $("#panel").load("panelTCQ.php?condition="+ $("#condition").val()+"&datepicker="+ $("#datepicker").val());
...
<div style="text-align:center;"><h2>รายงานเงินโอน TAC ค่าวิทยุ</h2></div>
...
<select name="condition" id="condition">
	...
	<option value="1">วันที่โอนเงินเข้าธนาคาร</option>
</select>
