...
function myConType()
{
	...
	if(document.getElementById("chk_con_type").value == "GUARANTEED_INVESTMENT")
	{
...
function noUseIt() // ไม่ใช้วงเงิน
{
	...
	var selectBorrowers = $.ajax({    // รับค่าจาก ajax เก็บไว้ที่ตัวแปร selectBorrowers  
		url: "selectBorrowers_sale_on_consignment.php", // ไฟล์สำหรับการกำหนดเงื่อนไข  
		//data:"main="+main, // ส่งตัวแปรแบบ GET
		async: false
	}).responseText;
...
<tr>
	<td align="right">จำนวนเงินขายฝาก <font color="#FF0000"><b> * </b></font> : </td>
...
<tr>
	...
	<td><input type="textbox" name="conLoanIniRate"><?php if($chk_con_type == "GUARANTEED_INVESTMENT"){ echo " <font color=\"#FF0000\">หากเป็นอัตราดอกเบี้ยต่อเดือนให้กรอกโดยนำอัตรานั้นมาคูณ 12</font>"; } ?></td>
</tr>
<tr>
...
<tr>
	<td align="right">จำนวนเงินสินไถ่<font color="#FF0000"><b> * </b></font>  : </td>
...
<tr>
	...
	<td><input type="textbox" name="conFirstDue" id="conFirstDue"><?php if($chk_con_type == "GUARANTEED_INVESTMENT"){ echo " <font color=\"#FF0000\">หากมี BEGINNING ณ วันรับสินค้า ให้เลือกเป็นวันที่รับสินค้า</font>"; } ?></td>
</tr>
<tr>
...
<tr>
	...
	<td><input type="textbox" name="conFineRate" id="conFineRate" value="<?php echo $conFineRate; ?>"></td>
</tr>
...
<tr>
	<td align="right">ผู้ขายฝาก <font color="#FF0000"><b> * </b></font> : </td>
