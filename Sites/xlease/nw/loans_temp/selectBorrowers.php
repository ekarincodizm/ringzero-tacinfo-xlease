...
function CreateNewRow()
	{
		...
		newCell.innerHTML = "ระบุผู้กู้ร่วม :";
...
<table align="center">
	<tr>
		<td align="center" colspan="2">
			ปุ่มเพิ่ม /ลบ ผู้กู้ร่วม <input type="button" value=" เพิ่ม " onclick="javascript : CreateNewRow();"><input type="button" value=" ลบ " onClick="javascript : RemoveRow();">
		</td>
	</tr>
	<tr>
		<td colspan="2">
