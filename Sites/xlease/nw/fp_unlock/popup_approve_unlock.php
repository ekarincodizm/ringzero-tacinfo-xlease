...
<title>อนุมัติสัญญาเช่าซื้อ</title>
	...
	function createXMLHttpRequest() {
		...
		function startRequest_nuLock(appvStatus)
		{
			...
			else
			{
				...
				for(var i=0; i<d.length; i++)
				{
					...
					{
						appvRemarkSent = appvRemarkSent+'<br>'+d[i];
					}
				}
				
				xmlHttp.open("get", "process_approve_unlock.php?autoID="+autoID+"&appvStatus="+appvStatus+"&appvRemark="+appvRemarkSent, true);
				xmlHttp.onreadystatechange = function () {
					if (xmlHttp.readyState == 4) {
						if (xmlHttp.status == 200) {
							...
							opener.location.reload(true);
							alert('เกิดข้อผิดพลาด ' + xmlHttp.statusText);
							self.close();
						}
					}
	...
	<div id="warppage" style="width:800px; height:auto;">
		...
		<div id="contentpage" style="height:auto;">
			<div id="login"  style="height:auto; width:800px; text-align:left; margin-left:auto; margin-right:auto;">
				...
				$idno = pg_result($qry_data,0);
				$doerRemark = pg_result($qry_data,1);
						...
						<table width="782" border="0">
								...
								<td colspan="4">
									<table>
										<tr>
											...
											<td><textarea cols="60" name="doerRemark" id="doerRemark" readOnly><?php echo $doerRemark; ?></textarea></td>
										</tr>
									</table>
								</td>
							</tr>
							<tr>
								<td colspan="4">
									<table>
										<tr>
											<td>หมายเหตุการอนุมัติ : </td>
											<td><textarea cols="60" name="appvRemark" id="appvRemark"></textarea></td>
										</tr>
									</table>
								</td>
							</tr>
							<tr>
								<td colspan="4" align="center">
									<input type="button" value="อนุมัติ" onClick="startRequest_nuLock(1)" style="cursor:pointer;" > &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="button" value="ไม่อนุมัติ" onClick="startRequest_nuLock(0)" style="cursor:pointer;" > &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
