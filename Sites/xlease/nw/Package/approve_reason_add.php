...
<form name="frm" action="approve_query_add_no.php" method="post">

<!--Hidden value-->
<?php for($z=0;$z<sizeof($appfpackaddID);$z++){ ?>
	<input type="hidden" name="appfID[]" value="<?php echo $appfpackaddID[$z]; ?>">
<?php } ?>				
