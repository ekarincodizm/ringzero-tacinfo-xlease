...
function check(){
	...
	if(($("#bankint").val()!='')&&(selectdate==true)&&(checkerror==true) ){
		...
		$("#detail").load("frm_listdetail.php?date1="+r[i].value+"&bankint="+$("#bankint").val()+"&year1="+$("#year1").val()+"&month1="+$("#month1").val()+"&year2="+$("#year2").val()
		+"&datepicker="+$("#datepicker").val()+"&datefrom="+$("#datefrom").val()+"&dateto="+$("#dateto").val()+"&cancel="+cancel) ;
		}
	else{
		if($("#bankint").val()==''){
			theMessage = theMessage + "\n --> กรุณาเลือกบัญชี";	
...
var finddate;
var check=true;
var theMessageerror = "กรุณาเลือกเงื่อนไข ที่จะค้นหาให้ครบ: \n-----------------------------------\n";
//เลือก เดือน ปี
...
<table align="center">
	<tr>
		...
		<td><b>ค้นหาจาก:</b></td>		
		<td><input type="radio" id="alldate" name="date1"  value="0" <?php if($date1=="" || $date1=="0"){ echo "checked"; }?> onclick="hidegen()"/></td>
		<td>ทุกช่วงเวลา</td></tr>
		<tr>
			<td colspan="3"></td>				
			<td><input type="radio" id="date4" name="date1"  value="4" <?php if($date1=="4"){ echo "checked"; }?> onclick="hidegen()" /></td>				
			<td>ตามวันที่ :</td>
			<td>
		...
		<td colspan="3"></td>
		<td>
		<input type="radio" id="date1" name="date1"  value="1" <?php if($date1=="1"){ echo "checked"; }?> onclick ="showgen(<?php echo $empl;?>)"/></td>
		<td>ตามเดือน:</td>
	...
	<tr><td></td>
		<td></td>
		<td></td>
		<td><input type="radio" id="date2" name="date1"  value="2"  <?php if($date2=="2"){ echo "checked"; }?> onclick ="showgen(<?php echo $empl;?>)"/></td>
		<td>ปี :</td>
		<td>
	...
	<tr>
			<td colspan="3"></td>	
			<td><input type="radio" id="date3" name="date1"  value="3" <?php if($date1=="3"){ echo "checked"; }?> onclick="hidegen()"/></td>			
			<td>ตามช่วง: จาก </td>
			<td>
	...
	<input type="button" id="gen"  value="GEN" onclick="gendata()"/></td></tr>
</table>
</fieldset><br>
<font color="red"><b>
