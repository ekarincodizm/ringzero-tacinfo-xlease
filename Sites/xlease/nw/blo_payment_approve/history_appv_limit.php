...
<html>
<head>
    <title>(BLO) ประวัติการอนุมัติรับชำระเงิน 30 รายการล่าสุด</title>
...
<tr>
	<td>
		...
		<table width="100%" border="0" cellSpacing="1" cellPadding="3" align="center" bgcolor="#FFFFFF">
			<tr bgcolor="#FFFFFF">
				<td colspan="11" align="left" style="font-weight:bold;">(BLO) ประวัติการอนุมัติรับชำระเงิน 30 รายการล่าสุด<input type="button" value="แสดงประวัติทั้งหมด" onclick="javascript:popU('history_appv.php','','toolbar=no,menubar=no,resizable=no,scrollbars=yes,status=no,location=no,width=1400,height=650')" style="cursor:pointer;"></td>
			</tr>
			...
			<?php
				$qry_blo = pg_query("select *, \"receiptStamp\"::date as \"receiptDate\"
									from \"blo_receipt_temp\" where \"appvStatus\" in('0','1') order by \"appvStamp\" DESC limit 30 ");
