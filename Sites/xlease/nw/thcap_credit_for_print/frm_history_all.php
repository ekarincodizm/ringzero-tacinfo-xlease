...
<html>
<head>
<title>ประวัติการ reprint ทั้งหมด</title>
...
<body>
<center><h1>ประวัติการ reprint ทั้งหมด</h1></center>
<table align="center" width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#BBBBEE">
	...
	$i=0;
	$costold="";	
	//เลือกรายการ ทั้งหมด ที่ ที่ทำรายการใน ตาราง  thcap_dncn_reprint ที่มีการสั่งพิมพ์
	$query = pg_query("select * from account.\"thcap_dncn_reprint\" where \"printTime\" <> '0' order by  \"printStamp\" desc");
