							...
							<table width="100%" cellspacing="1" cellpadding="1" style="margin-top:1px" align="center">
								...
								<?php
									...
									$qry_motorcycle = pg_query("
																SELECT *
																FROM thcap_asset_biz_detail_10 a
																LEFT JOIN \"thcap_asset_biz_detail\" e ON a.\"assetDetailID\" = e.\"assetDetailID\"
																LEFT JOIN \"thcap_asset_biz_model\" b ON e.\"model\" = b.\"modelID\"
																LEFT JOIN \"thcap_asset_biz_brand\" c ON e.\"brand\" = c.\"brandID\"
																LEFT JOIN \"thcap_asset_biz\" f ON e.\"assetID\"=f.\"assetID\"
																where e.\"materialisticStatus\"<>'9' and f.\"ActiveStatus\"<>'0'
									...
									if($rows){
										while($result = pg_fetch_array($qry_motorcycle)){
											...
											echo "
													...
													<td align=\"center\">".$result["motorcycle_no"]."</td>
													<td align=\"center\">".$result["Pump_num"]."</td>
													<td align=\"center\">".$result["EngineCC"]."</td>
											...
											IF($rowswait > 0){
												...
												echo "	
													<td align=\"center\">(รออนุมัติ)<img style=\"cursor:pointer;\" onclick=\"popU('../thcap_add_asset/add_asset_for_sales_10.php?ascenID=$ascenID&readonly=t&method=edit','','toolbar=no,menubar=no,resizable=no,scrollbars=yes,status=no,location=no,width=900,height=600')\" src=\"../images/detail.gif\" width=\"20px;\" height=\"20px;\"></td>	
												</tr>
												";	
											}else{
												echo "	
													<td align=\"center\"><img style=\"cursor:pointer;\" onclick=\"popU('../thcap_add_asset/add_asset_for_sales_10.php?assetdetailID=$assetDetailID&method=edit','','toolbar=no,menubar=no,resizable=no,scrollbars=yes,status=no,location=no,width=900,height=600')\" src=\"../images/onebit_20.png\" width=\"20px;\" height=\"20px;\"></td>	
												</tr>
												";
											}	
										}
