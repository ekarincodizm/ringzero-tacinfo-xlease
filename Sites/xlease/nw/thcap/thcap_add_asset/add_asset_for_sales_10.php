...
function chklist(){
	...
	<?php IF($emplevel <= 1 and $method=='edit'){	?>
	...
	if(document.frm.car_mileage.value==""){
		message = message + '- ระยะทางไมล์\n';	
		numchk = numchk + 1;
	}
	if(document.frm.car_color.value==""){
...
<div align="center">
	<div style="width:800px; display:block;">
		<form action="process_add_10.php" method="POST" name="frm">
			...
			<fieldset style="margin-bottom:15px;">
				<legend><b><?php echo $txthead;?>ข้อมูลรถจักรยานยนต์</b></legend>
					...
					<tr>
						<td>
							...
							<table width="100%" >	
								...
								<tr>
									<td align="right"><b>ชนิดรถ  : </b></td>
									<td width="15%"><input type="text" name="car_type" size="15" value="รถจักรยานยนต์" <?php echo $car_type; ?> readonly="true"></td>
									<td width="15%" align="right" ><b>ระยะทางไมล์ : </b></td>
									<td width="20%"><input type="text" name="car_mileage" size="10" onkeypress="check_num(event);" value="<?php echo $car_mileage ?>" <?php echo $look; ?>><b> กิโลเมตร</b><font color="red" >*</font></td>
									<td align="right"><b>สีรถ : </b></td>
									<td>
									<select name="car_color" <?php echo $look2; ?>>
										<option value="">--เลือก--</option>
										<?php	
											$qrycolor=pg_query("select * from \"thcap_asset_biz_detail_10_color\" order by \"car_color\"");
								...
								<tr>
									...
									<td align="right"><b>ปีที่จดทะเบียน (พ.ศ.) : </b></td>
