...
$In_Frame_No = pg_escape_string($_GET["frameno"]);
...
$txthead="เพิ่ม";
	...
	$Sql_Get_Asset_For_Input = "
									SELECT 
											b.brand_name,
											c.model_name,
											a.\"productCode\" as frame_no,
											d.\"astypeName\",
											a.\"secondaryID\" as \"Engine_no\"
									FROM 
											thcap_asset_biz_detail  a 
												LEFT JOIN thcap_asset_biz_brand b
													ON a.brand = b.\"brandID\"
												LEFT JOIN thcap_asset_biz_model c
													ON a.model = c.\"modelID\" 
												LEFT JOIN thcap_asset_biz_astype d
													ON a.\"astypeID\" = d.\"astypeID\"	
						...
						<td>
							...
							<table width="100%" >	
								...
								<tr>
									...
									<td width="25%"><input type="text" name="car_mileage" id = "car_mileage"  size="10" onkeypress="check_num(event);" value="<?php echo $car_mileage ?>" ><b> กิโลเมตร</b><font color="red" >*</font></td>
								...
								<tr>
									...
									<td><input type="text" size="50" name="engineno" id = "engineno" value = "<?php echo $In_Engine_No; ?>"><font color="red" >*</font></td>
									<td align="right" width="10%"><b>เลขตัวถัง : </b></td>
									<td colspan="4"><input type="text" size="50" name="bodyno" id = "bodyno" value="<?php echo $In_Frame_No; ?>" <?php echo $look; ?>><font color="red" >*</font></td>
								</tr>
								<tr>
							...
							<table width="100%" >							
								<tr align="center">
									<td><input type="submit" value=" บันทึก " onclick="return chklist();" style="width:150px; height:50px; cursor:pointer;" /></td>
