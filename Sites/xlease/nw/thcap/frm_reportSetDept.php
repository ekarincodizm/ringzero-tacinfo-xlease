...
<table width="900" border="0" cellspacing="0" cellpadding="0" align="center">
    <tr>
        <td>
			<div style="text-align:center"><h2>(THCAP) รายงานการตั้งหนี้เงินกู้</h2></div>       
			<div style="float:right"><input type="button" value="  Close  " onclick="window.close();"></div>
			<div style="clear:both;"></div>
			<fieldset><legend><B>รายงานการตั้งหนี้เงินกู้</B></legend>
				<div align="center">
					<div class="ui-widget">
						<p align="center">
							<b>รายงานตาม</b>
						...
						<tr style="font-weight:bold;" valign="top" bgcolor="#79BCFF" align="center">
							...
							<th id="a8" class="sort-text" style="cursor:pointer;">สถานะของหนี้</th>
						</tr>
						</thead>
						<?php
						$i=0;
						...
						if($numreceipt==0){
							...
							echo "<tr>
							<td class=\"sum\" align=right width=\"523\"><b>รวมเงิน</b></td><td align=right class=\"sum\" width=\"100\"><b>".number_format($sum_amt,2)."</b>
			...
			<div><font color="red"><b>*สถานะของหนี้ : สถานะปัจจุบันของหนี้นั้นๆ ขณะเรียกสัญญา ซึ่งอาจไม่ตรงกับครั้งแรกที่ตั้ง</b></font></div>
        </td>
    </tr>
</table>
</form>
