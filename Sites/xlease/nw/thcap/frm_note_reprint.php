...
$logid = pg_escape_string($_GET["logid"]);
$qry_sel = pg_query("SELECT \"receipt_id\",\"reprint_reason\" FROM \"thcap_reprint_log\" where id = '$logid'");
...
<b>เลขที่ใบเสร็จ</b> : <?php echo $result["receipt_id"]; ?>
</div>
