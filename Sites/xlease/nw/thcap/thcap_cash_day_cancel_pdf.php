...
$buss_name=iconv('UTF-8','windows-874',"(THCAP) รายงานใบเสร็จรับชำระประจำวันที่ถูกยกเลิก");
...
$cline = 39;
$nub = 1;
$qryreceipt=pg_query("select a.\"receiptID\" as receiptid,a.\"receiveDate\",b.\"approveDate\",a.\"contractID\",c.\"cusFullname\",a.\"receiveAmount\" as receiveamount,a.\"byChannel\",null,null,null,'1000' as typepay
	from thcap_temp_cancel_int a
	inner join thcap_temp_receipt_cancel b on a.\"receiptID\"=b.\"receiptID\"
	left join \"thcap_v_receipt_details\" c on b.\"receiptID\"=c.\"receiptID\"
	where $conditiondate $conditionchannel and \"approveStatus\"='1' order by receiptid");
$i=0;
$sum_amt = 0;
$sum_all = 0;
$old_doerID="";
