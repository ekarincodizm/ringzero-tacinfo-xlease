...
$pdf->SetXY(5,16);
$buss_name=iconv('UTF-8','windows-874',"(THCAP) รายงานรับชำระประจำวันเฉพาะบุคคล");
...
$qryreceipt=pg_query("select c.\"receiptID\" as receiptid,c.\"receiveDate\",e.\"doerStamp\",d.\"ChannelAmt\" as \"receiveAmount\",
	e.\"cusFullname\",d.\"byChannel\",e.\"doerID\" as doerid,'1000' as typepayid,a.\"tpDesc\",null as debtid 
	from thcap_v_receipt_details e
	left join \"thcap_temp_int_201201\" c on e.\"receiptID\"=c.\"receiptID\"
	left join account.\"thcap_typePay\" a on a.\"tpID\"='1000'
	left join \"thcap_temp_receipt_channel\" d on e.\"receiptID\"=d.\"receiptID\"
	where  $conditiondate $conditionchannel and c.\"contractID\" is not null and e.\"doerID\"='$doerID'order by e.\"doerID\",c.\"receiptID\",d.\"byChannel\"");
$i=0;
$sum_amt = 0;
$sum_all = 0;
$old_doerID="";
...
//show all record
	if($receiptID==$old_receiptID){
		...
		$pdf->SetXY(166,$cline);
		$buss_name=iconv('UTF-8','windows-874',"$tpID - $detail");
		$pdf->MultiCell(75,4,$buss_name,0,'L',0);
