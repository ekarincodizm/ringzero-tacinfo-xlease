...
<center><h1>ประวัติการอนุมัติยกเลิกใบเสร็จ</h1></center>
			...
			while($res_app=pg_fetch_array($qry_app)){
				...
				if($nubchk>0){ //แสดงว่ายังไม่ถูกลบ
					$qry_receipt2=pg_query("	
												SELECT a.\"cancelID\",a.\"contractID\",a.\"receiptID\",\"fullname\",\"requestDate\",e.\"receiveDate\",f.\"receiveAmount\",e.\"nameChannel\",e.\"debtID\",e.\"typePayID\",e.\"byChannelRef\",e.\"byChannel\"
												FROM \"thcap_temp_receipt_cancel\" a
