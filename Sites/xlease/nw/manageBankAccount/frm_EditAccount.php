...
<html>
<head>
    <title>แก้ไขบัญชีธนาคารบริษัท</title>
...
<tr>
    <td>      
		<div class="header"><h2>แก้ไขบัญชีธนาคารบริษัท</h2></div>
		<div class="wrapper">
			<fieldset><legend><B>กรายละเอียด</B></legend>	
				<table width="100%" border="0" cellSpacing="0" cellPadding="5" align="center">
				<tr align="left">
					<td align="right"><b>รหัสช่องทาง</b></td>
					<td width="10" align="center">:</td>
					<td class="text_gray"><input type="text" name="BChannel" value="<?php echo $res['BChannel'];?>" size="30"></td>
				</tr>
				<tr align="left">
				...
				<tr align="left">
					...
					if($numname>0){
						$name=$res[BCompany]."#".$resname["full_name"];
					}else{
						$name='THCAP';
					}
					?>
					<input type="text" name="BCompany" id="BCompany" value="<?php echo $name; ?>" size="60">
					</td>
				</tr>
				<tr align="left">
					...
					<td class="text_gray">
						<select name="BType">
							<?php echo "<option value=\"1\" ";?> <?php if($res["BType"]=="1"){echo "selected";} ?> <?php echo ">กระแสรายวัน</option>"; ?>
							<?php echo "<option value=\"2\" ";?> <?php if($res["BType"]=="2"){echo "selected";} ?> <?php echo ">ออมทรัพย์</option>"; ?>
						</select>
					</td>
				</tr>
				<tr align="left">
					...
					<td class="text_gray">
						<select name="isChannel">
							<?php echo "<option value=\"0\" ";?> <?php if($res["isChannel"]=="0"){echo "selected";} ?> <?php echo ">ไม่เป็นช่องทางการรับชำระ</option>"; ?>
							<?php echo "<option value=\"1\" ";?> <?php if($res["isChannel"]=="1"){echo "selected";} ?> <?php echo ">เป็นช่องทางการรับชำระ</option>"; ?>
						</select>
					</td>
				</tr>
				<tr align="left">
					...
					<td class="text_gray">
						<select name="isTranPay">
							<?php echo "<option value=\"1\" ";?> <?php if($res["isTranPay"]=="0"){echo "selected";} ?> <?php echo ">ไม่ใช่</option>"; ?>
							<?php echo "<option value=\"0\" ";?> <?php if($res["isTranPay"]=="1"){echo "selected";} ?> <?php echo ">ใช่</option>"; ?>
						</select>
					</td>
				</tr>
				<tr align="left">
				...
				<tr align="center">
				  <td colspan=3 height="50"><input type="hidden" name="method" value="edit"><input type="hidden" name="BID" value="<?php echo $BID;?>"><input name="submit" type="submit" value="บันทึก" onclick="return validate()"><input name="button" type="button" onclick="window.close();" value="  ปิด  " /></td>
				</tr>
				</table>
			</fieldset> 
		</div>
