...
<html>
<head>
    <title>อนุมัติเพิ่มบัญชีธนาคารบริษัท</title>
...
<tr>
    <td>      
		<div class="header"><h2>อนุมัติเพิ่มบัญชีธนาคารบริษัท</h2></div>
		<div class="wrapper">
			<fieldset><legend><B>รายละเอียด</B></legend>	
				...
				<tr align="center">
				  <td colspan=3 height="50"><input type="hidden" name="statusapp" id="statusapp" ><input type="hidden" name="auto_id" value="<?php echo $auto_id;?>"><input type="hidden" name="method" value="approve"><input name="button" type="button" value="อนุมัติ" onclick="app(this.form,'app');"><input name="button" type="button" value=" ไม่อนุมัติ " onclick="app(this.form,'noapp');"/></td>
				</tr>
				</table>
			</fieldset> 
		</div>
