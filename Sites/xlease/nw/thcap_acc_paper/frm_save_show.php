	...
	<tr>
		<td colspan="2">
			<table width="100%">
				<tr>
					<td align="left" >
						<font size="3"><?php echo "$save_name(เดือน $mm ปี $yy)"; ?></font>
					</td>
					<td align="right" >
						<img src="../thcap/images/excel.png" height="20px"> 
						<a href="javascript:popU('frm_from_save_excel.php?save_id=<?php echo $save_id; ?>&chk_all=<?php echo $chk_all; ?>')"><b><u>ออกรายงาน (EXCEL)</u></b></a>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<img src="images/print.gif" height="20px">
						<a href="javascript:popU('frm_from_save_pdf.php?save_id=<?php echo $save_id; ?>&chk_all=<?php echo $chk_all; ?>')"><b><u>พิมพ์รายงาน (PDF)</u></b></a>
					</td>
				</tr>
			</table>
		</td>
...
while($res=pg_fetch_array($qry))
{
	...
	$abh_sum=  pg_query("SELECT \"auto_id\", \"ledger_balance\", \"income_statement\", \"balance_sheet\" from account.\"thcap_ledger_save_detail\" where  \"accBookserial\" ='$Acserial' and \"is_ledgerstatus\" = '1' 
	...
	$abh_list_detail=  pg_query("SELECT count(\"auto_id\") from account.\"thcap_ledger_save_detail\" where  \"accBookserial\" ='$Acserial'
	and EXTRACT(YEAR FROM \"ledger_stamp\") = '$yy' and \"is_ledgerstatus\"='0' and save_id = '$save_id' ");
	...
	<?php } ?>
		<td align="left"><a href="javascript:popU('save_acc_frm_Index.php?fromaccpaper=<?php echo '1'; ?>&accserial=<?php echo $Acserial; ?>&date1=<?php echo '1'; ?>&save_id=<?php echo $save_id; ?>','','toolbar=no,menubar=no,resizable=yes,scrollbars=yes,status=no,location=no,width=1024,height=600')"><u><?php echo "$AcName";?></u></a></td>
		<td align="center">
		<table width="100%">
			<tr>
				<td align="center" title="<?php echo "$Acserial";?>"><?php echo "$AcID";?></td>
			</tr>
		</table>
		</td>
		<?php
		...
		if($auto_id != "")
		{
			...
			{
				echo "<td align=\"center\" colspan=\"2\" bgcolor=$color><input type=\"radio\" name=\"selectstatement$auto_id\" id=\"income$auto_id\" value=\"income\" disabled>งบกำไรขาดทุน</td>";
				echo "<td align=\"center\" colspan=\"2\" bgcolor=$color_1><input type=\"radio\" name=\"selectstatement$auto_id\" id=\"balance$auto_id\" value=\"balance\" disabled>งลดุล</td>";
				echo "<td align=\"center\" ><input type=\"button\" value=\"SAVE\" onClick=\"setstatement('$auto_id');\" disabled></td>";
			}
			elseif($income_statement != "")
			{
				...
				echo "<td align=\"center\"><input type=\"button\" value=\"ตั้งค่าใหม่\" onClick=\"del('$auto_id');\" disabled></td>";
			}
