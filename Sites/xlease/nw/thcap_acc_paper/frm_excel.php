...
$objPHPExcel->getActiveSheet()->SetCellValue('A2', 'ประจำเดือน '.$show_month.' พ.ศ. '.$show_yy);
...
while($res=pg_fetch_array($qry))
{
	...
	$abh_sum=  pg_query("SELECT \"ledger_balance\", \"income_statement\", \"balance_sheet\" from account.\"thcap_ledger_detail\" where  \"accBookserial\" ='$Acserial' and \"is_ledgerstatus\" = '1' 
...
$datwshow = "ประจำเดือน ".$show_month." พ.ศ. ".$show_yy;
