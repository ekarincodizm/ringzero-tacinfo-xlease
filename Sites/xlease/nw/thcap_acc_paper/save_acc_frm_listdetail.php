...
<table width="100%" border="0" cellSpacing="1" cellPadding="3" >
	...
	<td align="right">
		...
		<a href="javascript:popU('save_acc_frm_pdf.php?date1=<?php echo $select_Search;?>&bankint=<?php echo $select_bid;?>&year1=<?php echo $year1;?>&month1=<?php echo $month1;?>&year2=<?php echo $year2;?>&datepicker=<?php echo $datepicker;?>&datefrom=<?php echo $datefrom;?>&dateto=<?php echo $dateto;?>&cancel=<?php echo $cancel;?>&save_id=<?php echo $save_id; ?>')"><b><u>พิมพ์รายงาน (PDF)</u></b></a>
	</td>
</tr>
</table>
...
if($select_Search=='1'){	//เดือนปี 	
	$abh_sum= pg_query("SELECT \"ledger_balance\" from account.\"thcap_ledger_save_detail\" where \"accBookserial\" ='$select_bid' and save_id = '$save_id'
	...
	$abh_sum= pg_query("SELECT \"ledger_balance\" from account.\"thcap_ledger_save_detail\" where \"accBookserial\" ='$select_bid' and save_id = '$save_id'
	AND ledger_id in (SELECT MAX(ledger_id)  from account.\"thcap_ledger_save_detail\" where \"accBookserial\" ='$select_bid' and save_id = '$save_id'
...
{// ถ้าเลือกแบบวันที่
	...
	$qry_chk_date_gen = pg_query("select auto_id from account.\"thcap_ledger_save_detail\" where EXTRACT(YEAR FROM \"ledger_stamp\") = '$focus_year' AND EXTRACT(MONTH FROM \"ledger_stamp\") = '$focus_month' and save_id = '$save_id' ");
...
if($year!='2555'){
			...
			{	
				...
				if($select_Search=='1'){  //ตามเดือน ปี
					...
					from account.\"thcap_ledger_save_detail\" a  
					...
					where a.\"is_ledgerstatus\"='0' and a.\"accBookserial\"='$select_bid' and  EXTRACT(YEAR FROM a.\"ledger_stamp\") = '$year1'  and a.save_id = '$save_id'
					...
					left join account.\"all_accBookHead\" b  on a.\"abh_autoid\"=b.\"abh_autoid\"	
					left join account.\"all_accBook\" d  on  a.\"accBookserial\"=d.\"accBookserial\"
					where a.\"is_ledgerstatus\"='0' and a.\"accBookserial\"='$select_bid' and  EXTRACT(YEAR FROM a.\"ledger_stamp\") = '$year2' and a.save_id = '$save_id'
					$condition";
					...
					left join account.\"all_accBookHead\" b  on a.\"abh_autoid\"=b.\"abh_autoid\"	
					left join account.\"all_accBook\" d  on  a.\"accBookserial\"=d.\"accBookserial\"
					where a.\"is_ledgerstatus\"='0' and a.\"accBookserial\"='$select_bid' and a.save_id = '$save_id' $condition";
					//วันที่ ยอดมา
					$tiemto="2013"."-"."01"."-01";
					...
					left join account.\"all_accBookHead\" b  on a.\"abh_autoid\"=b.\"abh_autoid\"	
					left join account.\"all_accBook\" d  on  a.\"accBookserial\"=d.\"accBookserial\"
					where a.\"is_ledgerstatus\"='0' and a.\"accBookserial\"='$select_bid' and a.save_id = '$save_id'
				...
				$query.=" order by a.\"ledger_id\" asc ";
				...
				else
				{
					...
					{ // ถ้าไม่มีรายการย่อย แต่มียอดยกมา
						...
						if($select_Search=='1'){	//เดือนปี 	
							$qry_stamp= pg_query("SELECT max(\"ledger_stamp\")::date from account.\"thcap_ledger_save_detail\" where \"accBookserial\" ='$select_bid' and save_id = '$save_id'
					...
					$abh_sum=  pg_query("SELECT  \"ledger_balance\" from account.\"thcap_ledger_save_detail\" where  \"accBookserial\" ='$select_bid' and \"is_ledgerstatus\" = '1' and save_id = '$save_id'
