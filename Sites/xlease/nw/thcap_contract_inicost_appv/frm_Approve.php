...
<form name="frm" method="POST">
		<div class="wrapper">		
			...
			<?php
			if($tab_id=='0'){	//ทุกประเภทสัญญาทั้งหมด
				...
				$qry_con=pg_query("select a.\"contractID\",a.ini_add_user,a.ini_add_stamp,b.\"conType\",b.\"conDate\",thcap_get_iniinvestmentamt(a.\"contractID\") as investment,\"thcap_get_conEndDate\"(a.\"contractID\") as \"FconEndDate\"  from \"thcap_contract_inicost\" a
				left join \"thcap_contract\" b on a.\"contractID\"= b.\"contractID\"
				where a.\"ini_appv_status\"='2' and b.\"conType\"='$tab_id' group by a.\"contractID\",a.\"ini_add_stamp\",a.\"ini_add_user\",b.\"conType\",b.\"conDate\"  order by a.\"ini_add_stamp\" ASC  ");
			}
			...
			if($i%2==0){
				...
				echo "<td>$addStamp</td>";
				echo "<td><font color=\"#0000ff\"><u><a onclick=\"javascript:popU('detail_Appv.php?contractID=$contractID&ini_auto_id=$autoID&conDate=$contractDate&conEndDate=$conEndDate&conType=$contractType&fullname=$addFulname&addStamp=$addStamp&addUser=$addUser','','toolbar=no,menubar=no,resizable=no,scrollbars=yes,status=no,location=no,width=1000,height=800')\"style=\"cursor:pointer\"><img src=\"images/detail.gif\"/></a></u></font></td>";
			echo "</tr>";
			} //endwhile
			?>
			<?php
			...
			?>
			<tr bgcolor="#6699FF">
				<td colspan="9" align="left"><b>รายการทั้งหมด <?php echo $num_App;?> รายการ<b></td>
			</tr>
		</div>
</table>
</form>