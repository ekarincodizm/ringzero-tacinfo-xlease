...
<html>
<head>
<title>ประวัติการอนุมัติลูกค้านิติบุคคล</title>
...
<body>
<center><h1>ประวัติการอนุมัติลูกค้านิติบุคคล</h1></center>
<table align="center" width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#BBBBEE">
    ...
    <?php
    $query = pg_query("select * from public.\"th_corp_temp\" c where c.\"Approved\" is not null and c.\"corpID\"='0' union select * from public.\"th_corp_temp\" a where a.\"Approved\" is not null and a.\"corpID\"<>'0' and a.\"corpEdit\"=(select min(b.\"corpEdit\") from public.\"th_corp_temp\" b where b.\"corpID\"=a.\"corpID\") order by \"appvStamp\" desc");
