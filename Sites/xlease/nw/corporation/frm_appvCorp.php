...
<html>
<head>
    <title>อนุมัติลูกค้านิติบุคคล</title>
...
<body>
<center><h2>อนุมัติลูกค้านิติบุคคล</h2></center>
<br>
...
<table align="center" width="80%" border="0" cellspacing="1" cellpadding="1" bgcolor="#BBBBEE">
	...
	while($result = pg_fetch_array($query))
	{
		...
		echo "<td align=\"center\"><a onclick=\"javascript:popU('frm_detail_appvCorp.php?corp_regis=$corp_regis','','toolbar=no,menubar=no,resizable=no,scrollbars=yes,status=no,location=no,width=950,height=700')\" style=\"cursor:pointer;\"><font color=\"#0000FF\"><u>ตรวจสอบ</u></font></a></td>";
		echo "</tr>";
	}
	if($numrows==0){
