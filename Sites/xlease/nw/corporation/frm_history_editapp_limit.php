...
<fieldset style="width:95%">
	<legend>
		<font color="black"><b>
			ประวัติการอนุมัติ 30 รายการล่าสุด (<a style="color:#0099FF;cursor:pointer;" onclick="javascript:popU('frm_history_editapp.php','','toolbar=no,menubar=no,resizable=no,scrollbars=yes,status=no,location=no,width=1400,height=650')"><u>ทั้งหมด</u></a>) </font>
		</b></font>
	</legend>
    <br />
    <table align="center" width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#BBBBEE">
        ...
        <?php
        $query = pg_query("select * from public.\"th_corp_temp\" a where a.\"Approved\" is not null and a.\"corpID\"<>'0' and a.\"corpEdit\"<>'0' and a.\"corpEdit\"<>(select min(b.\"corpEdit\") from public.\"th_corp_temp\" b where b.\"corpID\"=a.\"corpID\") order by \"appvStamp\" desc limit 30");
