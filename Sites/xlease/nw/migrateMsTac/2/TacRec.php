...
pg_query("BEGIN WORK");
$status = 0;
$sql_fc=mssql_query("select *,CONVERT(varchar(4), YEAR(RadioOffDate)) + '-' + CONVERT(varchar(2), MONTH(RadioOffDate)) + '-' + CONVERT(varchar(2), DAY(RadioOffDate)) + ' ' + CONVERT(varchar, RadioOffDate, 8) AS EffectDate from TacRec ",$conn); 
