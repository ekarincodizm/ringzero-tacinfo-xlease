...
$(document).ready(function(){
	$("#buttonsave").click(function(){
		if($("#resultcancel").val()==""){
			alert('กรุณาระบุเหตุผลที่ยกเลิกใบกำกับภาษี');
			$('#resultcancel').select();
			return false;
		}else{
			if(confirm('คุณยืนยันที่จะยกเลิกใบกำกับภาษีเหล่านี้!!')){
				$("#buttonsave").submit();
			}else{
				return false;
			}
...
<tr>
	...
	<?php
	if($statusshow==1){
		echo "- ยืนยันการยกเลิกใบกำกับภาษี -";
	}else{
...
<?php
	//หาเหตุผลโดยการนำเลขที่ใบกำกับภาษีไปค้นในตาราง  thcap_temp_taxinvoice_cancel
