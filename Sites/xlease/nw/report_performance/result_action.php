...
<?php
	...
	echo "<td align=\"center\"><b>การกระทำ</b></td>";
	...
	echo "<td align=\"center\"><b>วันและเวลาที่กระทำ</b></td>";
	echo "</tr>";
	...
	function page_navigator($before_p,$plus_p,$total,$total_p,$chk_page,$searchWord,$searchType,$searchDate){   
		global $e_page;
		//global $querystr;
		$urlfile="report_action.php"; // ส่วนของไฟล์เรียกใช้งาน ด้วย ajax (ajax_dat.php)
		$per_page=10;
	...
	if($searchType=="2")
	{
		$q="select * from public.\"Vaction_log_adv\" where \"id_user\"='$searchWord' and cast(\"action_time\" as character varying) like '%$searchDate%' order by \"actionid\" asc";
	}
	else if($searchType=="1")
	{
		$q="select * from public.\"Vaction_log_adv\" where \"id_user\"='$searchWord' order by \"actionid\" desc";
	}
	$qr=pg_query($q);
