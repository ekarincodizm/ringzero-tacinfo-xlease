...
<body>
	<div class="header" align="center"><h1>(THCAP) ตรวจสอบยกเว้นเช็คค้ำตั๋วเงิน</h1></div>
	<div id="include"><?php include("frm_Request.php");?></div> <!--ตรวจสอบยกเว้นเช็คค้ำตั๋วเงิน -->
	<div id="include"><?php include("frm_listAppv.php");?></div> <!--รายการรออนุมัติยกเว็นเช็คค้ำตั๋วเงิน -->
