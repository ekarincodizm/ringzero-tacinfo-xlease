...
$Strsort3=pg_escape_string($_GET['sort3']);
if($Strsort3==""){$Strsort3="waive_app_stamp";}
$Strorder3=pg_escape_string($_GET['order3']);
...
if($Strorder3=="DESC"){
	...
	$NewStrorder3="DESC";
			...
			if($Strsort3=="waive_add_user" || $Strsort3=="waive_app_user"){
			...
			where \"statusCon\"<>'2'order by (select fullname from \"Vfuser\" where id_user = '$Strsort3' ) $Strorder3 ");
			} else if($Strsort3=="waive_add_stamp" || $Strsort3=="waive_app_stamp" ||$Strsort3=="statusCon"){
			$qry_con=pg_query("select *,thcap_get_iniinvestmentamt(a.\"contractID\") as investment,\"thcap_get_conEndDate\"(a.\"contractID\") as \"FconEndDate\" from \"thcap_contract\" a
			left join thcap_contract_waive_fa_chqguaranteed b on a.\"contractID\"= b.\"contractID\"
			where \"statusCon\"<>'2' order by b.\"$Strsort3\" $Strorder3 ");
			} else if($Strsort3=="investment"){
			$qry_con=pg_query("select *,thcap_get_iniinvestmentamt(a.\"contractID\") as investment,\"thcap_get_conEndDate\"(a.\"contractID\") as \"FconEndDate\" from \"thcap_contract\" a
			left join thcap_contract_waive_fa_chqguaranteed b on a.\"contractID\"= b.\"contractID\"
			where \"statusCon\"<>'2' order by \"investment\" $Strorder3 ");
			} else {
			$qry_con=pg_query("select *,thcap_get_iniinvestmentamt(a.\"contractID\") as investment,\"thcap_get_conEndDate\"(a.\"contractID\") as \"FconEndDate\" from \"thcap_contract\" a
			left join thcap_contract_waive_fa_chqguaranteed b on a.\"contractID\"= b.\"contractID\"
			where \"statusCon\"<>'2' order by a.\"$Strsort3\" $Strorder3 ");
			}
?>
...
<body>
	<table width="1000" border="0" cellspacing="0" cellpadding="0" style="margin-top:1px" align="center">
		<tr>
			<td>
				<div align="Center"><h1>ประวัติการอนุมัติยกเว้นเช็คค้ำตั๋วเงิน</h1></div>
				<div class="wrapper">		
					...
					<tr style="font-weight:bold;" valign="middle" bgcolor="#79BCFF" align="center">	
						...
						<td><a href="show_all_history.php?sort3=investment&order3=<?php echo $NewStrorder3;?>"><font color="black"><u>จำนวนเงินที่ลงทุน</u></font></td>
						<td><a href="show_all_history.php?sort3=conEndDate&order3=<?php echo $NewStrorder3;?>"><font color="black"><u>วันที่ครบกำหนดสัญญา</u></font></td>
						<td><a href="show_all_history.php?sort3=waive_add_user&order3=<?php echo $NewStrorder3;?>"><font color="black"><u>ผู้ขอยกเว้น</u></font></td>
						<td><a href="show_all_history.php?sort3=waive_add_stamp&order3=<?php echo $NewStrorder3;?>"><font color="black"><u>วันเวลาที่ขอยกเว้น</u></font></td>
						<td><a href="show_all_history.php?sort3=waive_app_user&order3=<?php echo $NewStrorder3;?>"><font color="black"><u>ผู้อนุมัติ</u></font></td>
						<td><a href="show_all_history.php?sort3=waive_app_stamp&order3=<?php echo $NewStrorder3;?>"><font color="black"><u>วันเวลาที่อนุมัติ</u></font></td>
						<td>หมายเหตุ</td>
						<td><a href="show_all_history.php?sort3=statusCon&order3=<?php echo $NewStrorder3;?>"><font color="black"><u>ผลการอนุมัติ</u></font></td>
					</tr>
					<?php
						...
						?>
						<tr bgcolor="#6699FF">
							<td colspan="12" align="left"><b>รายการทั้งหมด <?php echo $num_all;?><b></td>
						</tr>
					</table>
				</div>
			</td>
