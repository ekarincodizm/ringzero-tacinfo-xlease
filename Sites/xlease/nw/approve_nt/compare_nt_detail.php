...
<title>ประวัติอนุมัติ NT</title>
<script type="text/javascript">

</script>   
</head>
<body>
<div  align="center"><h2>รายละเอียดการอนุมัติ NT โดยพิจารณาจากข้อมูลปัจจุบันกับข้อมูลที่เปลี่ยนแปลงไป</h2></div>
...
<tr>
<?php
	$qry_chkapp = pg_query("SELECT result_noapprove,\"statusNT\" FROM \"nw_statusNT\" where  \"NTID\" = '$NTID' group by \"statusNT\",result_noapprove");
	list($result_noapprove,$statusNT) = pg_fetch_array($qry_chkapp);
	if($statusNT != '2' OR $statusNT != '0'){
		$chkapp = 'checked';
	}else if($statusNT == '2'){
		$chknotapp = 'checked';
	}
...
<tr>
	<td align="center">
		<input type="radio" name="status_approve" id="status_approve1" value="1" onclick="check_search()" <?php echo $chkapp; ?> disabled> อนุมัติ  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="radio" name="status_approve" id="status_approve2" value="2" onclick="check_search()" <?php echo $chknotapp; ?> disabled> ไม่อนุมัติ
	</td>
	<td></td>
</tr>
<?php if($statusNT == '2'){ ?>
	<tr>
		<td align="center" >
			<table width="50%" align="center">
				...
				<tr>
					<td><textarea name="result" cols="50" rows="4" id="s1" readonly><?php echo $result_noapprove ?></textarea></td>
				</tr>
			</table>
		</td>
		<td></td>
