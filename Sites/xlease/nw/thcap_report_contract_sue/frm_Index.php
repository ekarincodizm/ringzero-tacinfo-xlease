...
<html>
<head>
    <title>(THCAP) รายงานสัญญาที่ดำเนินคดี</title>
	...
	<script type="text/javascript">
		...
		function showReport()
		{
			...
			$("#panel").load("report_gui.php?selectTime="+'<?php echo $selectTime; ?>'+"&yy="+'<?php echo $yy; ?>'+"&mm="+'<?php echo $mm; ?>'+"&ym="+'<?php echo $ym; ?>'+"&focusDate="+'<?php echo $focusDate; ?>'+get_contype);
		}
...
<center>
<h1>(THCAP) รายงานสัญญาที่ดำเนินคดี</h1>
</center>
				...
				<fieldset><legend><B>เงื่อนไข</B></legend>
					<center>						
						<table>
							...
							<tr>
								<td align="right">วันที่ฟ้องดำเนินคดี : </td>
								<td align="left">
									<input type="radio" name="selectTime" value="a" <?php if($selectTime == "a"){echo "checked";} ?>>
									ทั้งหมด
								</td>
							</tr>
							<tr>
