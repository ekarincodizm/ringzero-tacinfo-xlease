...
$(document).ready(function(){
    ...
    $("#tag_names_m").autocomplete({
        source: "fu_listdatatag.php",
        minLength:1
    });

    $('#btn1').click(function(){
		var aaaa = $("#tag_names_m").val();
        var brokenstring=aaaa.split("#");
        $("#panel").load("fu_tag_showlistmain.php?comID="+ brokenstring[0]);
    });
...
<div class="style1" id="menu" style="height:25px; padding-left:10px; padding-top:10px; padding-right:10px;">ค้นหา การติดตาม <hr /></div>
<div id="contentpage" style="height:auto;">
<div id="login"  style="height:50px; width:800px; text-align:left; margin-left:auto; margin-right:auto;">
  <div class="style5" style="width:auto; height:100px; padding-left:10px;">
  <b></b>
	<input type="text" size="50" id="tag_names_m" name="tag_names_m" style="height:20;"/>
    <input type="button" value="ค้นหา" id="btn1"/>
    <input name="button" type="button" onclick="window.location.href='index.php'" value="ปิด" />
  <div class="style5" style="width:auto; height:100px; padding-left:10px;">
    <b></b>ระบุ ชื่อการติดตาม,ชื่อการสนทนา,ชื่อบริษัท 
</div>
</div>
</div>
