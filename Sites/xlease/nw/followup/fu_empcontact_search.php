...
$(document).ready(function(){
    ...
    $("#emp_names_m").autocomplete({
        source: "fu_listdataempcontact.php",
        minLength:2
    });
    ...
    $('#btn1').click(function(){
        ...
        $("#panel").load("fu_empcon_showlist.php?comID="+ brokenstring[0]);
    });
