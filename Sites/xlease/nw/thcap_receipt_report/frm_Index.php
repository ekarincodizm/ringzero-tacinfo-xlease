...
<head>
	...
	<title>(THCAP) รายงานใบเสร็จประจำวัน</title>
...
$(document).ready(function(){
    $('#btn00').click(function(){
        ...
        $("#panel").load("panel-receipt-report.php?datepicker="+ $("#datepicker").val() + "&type_date=" + $("#type_date").val() );
...
<fieldset><legend><B>(THCAP) รายงานใบเสร็จประจำวัน</B></legend>
...
<option value="1" selected="selected">จากวันที่ทำรายการ</option>
<option value="2">จากวันที่ออกใบเสร็จ</option>
</select>
</p>
