                                        ...
                                        <table width="780" border="0" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td valign="middle" align="center" id="top_menu_border">
                                           		  <form name="addNews" method="post" action="addNews_Process.php">
                                                    <table border="0" cellpadding="0" cellspacing="0" id="tb_postNews">
                                                        	<tr>
                                                            	<td id="td_title" valign="middle" align="right">หัวข้อข่าว.:</td>
                                                                <td><input name="tbxSubject" type="text" id="tbxSubject" value="" size="70" maxlength="200"></td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td id="td_NewsMessage">
                                                                	...
                                                                	<textarea name="tbxMessage" id="tbxMessage">
                                                                    </textarea>
                                                                </td>
                                                            </tr>
                                                            <tr>
...
<select name="lbNewsType" id="lbNewsType">
                                                                        <?php
                                                                            echo"<option value=\"$newsValue1\">$newsTitle1</option>";
                                                                            echo"<option value=\"$newsValue2\">$newsTitle2</option>";
                                                                            echo"<option value=\"$newsValue3\">$newsTitle3</option>";
                                                                        ?>
                                                                    </select>
