<?php
	...
	if($id!="")
	{
		if($banValue=="y")
		{
			$sql_ban="update \"TrMember\" set \"disabled\"='y' where \"UserID\"='$id'";
			pg_query($sql_ban);
		}
		else if($banValue="n")
		{
			$sql_n_ban="update \"TrMember\" set \"disabled\"='n' where \"UserID\"='$id'";
			pg_query($sql_n_ban);
		}
	}
                	...
                	<td align="center" valign="top" id="content">
                    	<table border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td align="center" valign="top" id="content">
                                    <div id="content_box1">
                                    	<form name="frmMain" action="manageUser.php" method="post">
                                        ...
                                        <table width="780" border="0" cellpadding="0" cellspacing="0" id="tb_ShowAllNews">
                                            ...
                                            <?php
												...
												function page_navigator($before_p,$plus_p,$total,$total_p,$chk_page,$type){   
													global $e_page;
													global $querystr;
													$urlfile="manageUser.php"; // ส่วนของไฟล์เรียกใช้งาน ด้วย ajax (ajax_dat.php)
													$per_page=10;
												...
												else
												{
													while($result=pg_fetch_assoc($qr))
													{
														...
														if($result['disabled']=="y")
														{
															...
															echo "<td id=\"td_Telephone2\" align=\"center\" valign=\"middle\">$telephone</td>";
															echo "<td id=\"td_Edit2\" align=\"center\" valign=\"middle\"><a href=\"editMember.php?userID=$id\"><img src=\"images/gtk-edit.png\" width=\"16\" height=\"16\"></a></td>";
															echo "<td id=\"td_Disable2\" align=\"center\" valign=\"middle\"><a href=\"manageUser.php?userID=$id&ban=n\"><img src=\"images/button-ban1.gif\"></a></td>";
															echo "</tr>";
														}
														else
														{
															...
															echo "<td id=\"td_Telephone1\" align=\"center\" valign=\"middle\">$telephone</td>";
															echo "<td id=\"td_Edit1\" align=\"center\" valign=\"middle\"><a href=\"editMember.php?userID=$id\"><img src=\"images/gtk-edit.png\" width=\"16\" height=\"16\"></a></td>";
															echo "<td id=\"td_Disable1\" align=\"center\" valign=\"middle\"><a href=\"manageUser.php?s_page=".$_GET['s_page']."&querystr=".$_GET['querystr']."&userID=$id&ban=y&txtSearch=$word\"><img src=\"images/button-ban.gif\"></a></td>";
															echo "</tr>";
														}
                                                	}
												}
