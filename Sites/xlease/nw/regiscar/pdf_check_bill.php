...
$pdf->SetXY(10,10);
$title=iconv('UTF-8','windows-874',"รายงานการเบิกค่าใช้จ่ายเกินทุน");
$pdf->MultiCell(190,4,$title,0,'C',0);

$pdf->SetFont('AngsanaNew','',15);
$pdf->SetXY(10,16);
if($year == ""){
$monthyear=iconv('UTF-8','windows-874',"แสดงข้อมูลทั้งหมดจนถึงปัจจุบัน");
}else{
$monthyear=iconv('UTF-8','windows-874',"ข้อมูลประจำเดือน$monthshow  พ.ศ.$year2");
}
