...
<html>
<head>
    <title>รายละเอียดการอนุมัติใบสำคัญจ่าย</title>
...
<div style="width:80%;margin-left:auto;margin-right:auto;">
	...
	<div style="margin-top:10px;" align="center"><h1>รายละเอียดการอนุมัติใบสำคัญจ่าย</h1></div>
<table width="100%">
	<tr >
		<td align="left">
			<div style="margin-top:10px;">
				<table align="left">
					<tr>
						...
						<td><a onclick="javascript:popU('../thcap_payment_voucher/voucher_channel_detail.php?voucherID=<?php echo $voucherID; ?>','','toolbar=no,menubar=no,resizable=no,scrollbars=yes,status=no,location=no,width=980,height=550');" style="cursor:pointer;"><font color="red"><u><?php echo $voucherID; ?></a></font></td>
					</tr>
					<tr>
