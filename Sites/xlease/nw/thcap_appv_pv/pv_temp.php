...
<body>
	<center>
	<h1>ประวัติการอนุมัติใบสำคัญจ่าย</h1>
	<table width="100%" border="0" cellSpacing="1" cellPadding="3" align="center" bgcolor="#F0F0F0">
		...
		<?php
		$qry_app = pg_query("select * from thcap_temp_voucher_pre_details where \"appvStatus\" <>'9' and \"voucherType\" ='1' order by \"appvStamp\" DESC ");
