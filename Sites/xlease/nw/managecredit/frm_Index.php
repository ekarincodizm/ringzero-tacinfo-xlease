...
<html>
<head>
    <title>จัดการประเภทสินเชื่อเช่าซื้อ</title>
		...
		<td>
			...
			<div id="panel" style="padding-top: 20px;">
				<table width="100%" align="center" border="0" cellSpacing="1" cellPadding="3" align="center" bgcolor="#D0D0D0">
					...
					?>
					<form method="post" name="form1" action="frm_addCredit.php">
					<tr height="50" bgcolor="#FFFFFF">
						<td colspan="5" align="right"><input type="submit" value="เพิ่มประเภทสินเชื่อ"><input type="button" value="  Close  " onclick="javascript:window.close();"></td>
					</tr>
					</form>
				</table>
			</div>
