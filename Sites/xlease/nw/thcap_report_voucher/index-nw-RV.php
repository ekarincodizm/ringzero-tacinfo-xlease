...
<body>
	...
	if($s_data == "yes") // ถ้ามีการคลิกค้นหา
	{
		...
		if($s_valuee=="0"){ //เลือกค้นหา Receive ID:
			...
			$qry_c1 = " where EXTRACT(YEAR FROM a.\"doerStamp\")='$s_sel_year' $condition_c ";
		}	 
		...
		<div align="center">
			<fieldset style="width:80%;">
				<legend>
					...
					<input type="button" value="รายการใบสำคัญรับ" style="height:4em;" disabled>
					<input type="button" value="รายการใบสำคัญรายวันทั่วไป" style="height:4em; cursor:pointer;" onClick="load_voucher('JV');">
				</legend>
				<form name="frm_RV" action="pdf_payment_voucher.php" method="post" target="_blank">
						...
						<table cellpadding="5" cellspacing="0" border="0" width="100%" bgcolor="#F0F0F0" align="center">
							<tr bgcolor="white">
								...
								<td colspan="8" align="right">	
									<input type="button" name="cancel" id="cancel" value="ขอยกเลิก ใบสำคัญรับ" onclick="validate_RV(this.form,'C');"/>				
									<input type="button" name="PrintPDF" id="PrintPDF" value="PrintPDF ใบสำคัญรับ" onclick="validate_RV(this.form,'PDF');"/>
								</td>
							</tr>
								...
								if($num_row>0){
									...
									if($i%2==0){	
										...
										if($voucherStatus == "0"){
											...
											echo "<td align=\"center\"><input type=\"checkbox\" name=\"select_print_RV[]\" id=\"select_print_RV$i\" value=\"$voucherID\"></td>";
