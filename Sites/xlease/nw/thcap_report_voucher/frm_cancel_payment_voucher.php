...
if($pop == "Y"){
	$select_print_PV[] = $_REQUEST["select_print_PV"];
}else{
	$select_print_PV = $_REQUEST["select_print_PV"];
}
...
<div align="center"><h1>ยืนยันยกเลิกรายการจ่าย</h1></div>
<form name="frm" action="process_cancel_pv.php" method="post" >
<?php
	$counter = 0;
...
?>
	...
	<div align="center" style="margin-top:20px;">
		<input type="submit" name="confirm_cancel" id="confirm_cancel" value="ยืนยันยกเลิกรายการจ่าย" onclick="return validate();">
