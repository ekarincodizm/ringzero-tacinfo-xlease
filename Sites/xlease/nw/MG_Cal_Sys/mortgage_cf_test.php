...
<?Php
	...
	<div class=\"form_description\">
				<h2>สรุปข้อมูลคำขอสินเชื่อเงินกู้</h2>
	 ...
	 ?>
		...
		<table width="400" border="1" align="center" cellspacing="0">
		  ...
		  <tr>
		    <td width="200" bgcolor="#F4F4F4" ><label class="description" for="element_3">
	 ...
	 ?>
		  ...
		  <tr>
		    <td bgcolor="#F4F4F4"><label class="description" for="element_5">
		      <div align="right">ค่าใช้จ่ายอื่นๆ  : 
	   
            </div></td>
		    <td><div align="left"><?Php echo "<b><font color='red'> ".$_POST[cmort_otherfee]."</font>" ; ?> บาท</div></td>
	      </tr>
		  <tr>
		    <td bgcolor="#F4F4F4"><label class="description" for="element_3">
	        <div align="right">วงเงินจดจำนอง  : </div></td>
