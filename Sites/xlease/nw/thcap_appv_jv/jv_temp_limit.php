...
<html>
<head>
	<title>ประวัติการอนุมัติใบสำคัญรายวันทั่วไป</title>
...
<body>
	<table width="100%" border="0" cellSpacing="1" cellPadding="3" align="center" bgcolor="#F0F0F0">
		<tr bgcolor="#FFFFFF">
			<td colspan="11" align="left" style="font-weight:bold;">ประวัติการอนุมัติใบสำคัญรายวันทั่วไป 30 รายการล่าสุด  <input type="button" value="แสดงประวัติทั้งหมด" onclick="javascript:popU('jv_temp.php','','toolbar=no,menubar=no,resizable=no,scrollbars=yes,status=no,location=no,width=1400,height=650')" style="cursor:pointer;"></td>
		</tr>
		...
		<?php
		$qry_app = pg_query("select * from thcap_temp_voucher_pre_details where \"appvStatus\" <> '9' and \"voucherType\" ='3' order by \"appvStamp\" DESC limit 30 ");
		...
		?>
			...
			<td><span onclick="javascript:popU('jv_detail_view.php?autoID=<?php echo $prevoucherdetailsid?>','','toolbar=no,menubar=no,resizable=no,scrollbars=yes,status=no,location=no,width=1000,height=700')" style="cursor:pointer;"><u>ตรวจสอบ</u></span></td>
		</tr>
		<?php
		} //end while
