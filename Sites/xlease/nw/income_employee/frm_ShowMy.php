...
<table width="750" border="0" cellSpacing="1" cellPadding="3" align="center" bgcolor="#F0F0F0">
	...
	<?php
		...
		where EXTRACT(YEAR FROM \"inc_date\")='$year' and inc_userid='$id_user'
		group by inc_userid,fullname,username,nickname,month order by month" );	
		...
		while($result=pg_fetch_array($query)){
			...
			echo "<td><img src=\"images/detail.gif\" onclick=\"javascript:popU('frm_Show_detail.php?inc_userid=$inc_userid&month=$month&year=$year','','toolbar=no,menubar=no,resizable=no,scrollbars=yes,status=no,location=no,width=990,height=700')\" style=\"cursor:pointer\"></td>";
			echo "</tr>";
