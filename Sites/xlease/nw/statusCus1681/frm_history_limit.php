...
<body>
	...
	<table align="center" width="85%" border="0" cellspacing="1" cellpadding="1" bgcolor="#CDC9C9">
		<tr><td colspan="8" bgcolor="#FFFFFF"><b>ประวัติการอนุมัติแก้ไขรับชำระชั่วคราว 1681 30 รายการล่าสุด</b><input type="button" value="แสดงประวัติทั้งหมด" onclick="javascript:popU('frm_history.php','','toolbar=no,menubar=no,resizable=no,scrollbars=yes,status=no,location=no,width=1400,height=650')" style="cursor:pointer;"></td></tr>
		...
		\"tacTempDate\", b.\"fullname\",c.\"fullname\", \"req_stamp\" ,\"app_stamp\",\"statusApp\" order by \"app_stamp\" DESC limit (30)");
