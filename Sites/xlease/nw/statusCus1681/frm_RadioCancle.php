...
<html>
<head>
    <title>ยกเลิกสัญญาวิทยุ 1681</title>
...
$(document).ready(function(){
    ...
    $('#btn1').click(function(){
        $("#panel").load("frm_CancelDlt.php?car="+ $("#car").val());
    });
});
...
<table width="900" border="0" cellspacing="0" cellpadding="0" align="center">
    <tr>
        <td>
			<div style="text-align:center;padding-bottom: 10px;"><h2>ยกเลิกสัญญาวิทยุ 1681</h2></div>
