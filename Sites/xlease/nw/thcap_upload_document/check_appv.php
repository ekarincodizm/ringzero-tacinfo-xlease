...
<legend><b>รายการรอตรวจสอบเอกสารสัญญาที่ upload</b></legend>
			<table width="100%" border="0" cellSpacing="1" cellPadding="3" align="center" bgcolor="#F0F0F0">
				...
				<tr>
				<?php
					$qry_appv = pg_query("select a.\"up_autoID\",a.\"contractID\",a.\"docTypename\",a.\"conType\",a.\"up_doerID\",a.\"up_doerStamp\",b.\"conType\" from thcap_upload_document as a 
					...
					while($res_appv = pg_fetch_array($qry_appv)){
						...
						echo "<tr class=\"even\" align=center>";
							...
							echo "<td><a onclick=\"javascript:popU('detail_appv.php?autoID=$up_autoID','','toolbar=no,menubar=no,resizable=no,scrollbars=yes,status=no,location=no,width=800,height=480')\"style=\"cursor:pointer\"><img src=\"images/detail.gif\"/></a></td>";
						echo "</tr>";
					} // end while
					if($nub == 0){
