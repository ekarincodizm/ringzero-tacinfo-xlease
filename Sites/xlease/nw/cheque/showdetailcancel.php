...
$qrychq=pg_query("select e.\"chqpayID\",\"typeName\",\"IDNO\",\"cusPay\",\"moneyPay\",\"datePay\",
c.\"BAccount\",c.\"BName\",c.\"BBranch\",c.\"BCompany\",a.\"typeChq\",a.\"note\",d.\"fullname\",\"cancelStamp\",\"cancelResult\" from cheque_cancel e
		left join cheque_pay a on e.\"chqpayID\"=a.\"chqpayID\"
		left join cheque_typepay b on a.\"typePay\"=b.\"typePay\"
		left join \"BankInt\" c on a.\"BAccount\"=c.\"BAccount\"
		left join \"Vfuser\" d on e.\"cancelUser\"=d.\"id_user\"
		where e.\"cancelID\"='$cancelID' ");
$reschq=pg_fetch_array($qrychq);
list($chqpayID2,$typeName,$IDNO,$cusPay,$moneyPay,$datePay,$BAccount,$BName,$BBranch,$BCompany,$typeChq,$note,$keyuser,$keyStamp,$result)=$reschq;
if($BName=="") $BName="-";
if($BBranch=="") $BBranch="-";
...
<title>แสดงรายละเอียดการยกเลิกเช็ค</title>
</head>
<body style="background-color:#ffffff; margin-top:0px;">
<div id="wmax" style="width:100%; height:100%; border:#666666 solid 0px; margin-top:0px;">
	<div class="style1" id="header" style="height:50px; width:auto; text-align:center; opacity:20;">
		<h2>- รายละเอียดการยกเลิกเช็ค -</h2>
	</div>
	...
	<div id="warppage"  style="width:570px; text-align:left; margin-left:auto; margin-right:auto;padding:10px;">
		...
		<tr  bgcolor="#FFCCCC" height="25">
			<td align="right" valign="top">ผู้ทำรายการยกเลิก : </td>
			<td bgcolor="#FFECEC"><?php echo $keyuser;?></td>
		</tr>
		<tr  bgcolor="#FFCCCC" height="25">
			<td align="right">วันเวลาที่ทำรายการยกเลิก : </td>
			<td bgcolor="#FFECEC"><?php echo $keyStamp;?></td>
		</tr>
		<tr  bgcolor="#FFCCCC">
			<td align="right" valign="top">เหตุผลที่ยกเลิก : </td>
			<td bgcolor="#FFECEC"><textarea name="result" cols="40" rows="5" readonly="true"><?php echo $result;?></textarea></td>
		</tr>
		<tr>
			<td colspan="4" height="80" bgcolor="#FFFFFF" align="center">
			<?php if($show=='1') {?>
			<form method="post" action="process_approve.php">
				<input type="hidden" name="chqpayID" id="chqpayID" value="<?php echo $cancelID; ?>">
