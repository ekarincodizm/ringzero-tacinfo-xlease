...
<head>
	...
	<title>(THCAP) ทำรายการใบสำคัญรายวันทั่วไป V.2</title>
...
<body>
<div class="header"><h1>(THCAP) ทำรายการใบสำคัญรายวันทั่วไป V.2</h1></div>
...
<form method="post" name="add_acc" id="add_acc" action="process_add_acc_send_v2.php">
