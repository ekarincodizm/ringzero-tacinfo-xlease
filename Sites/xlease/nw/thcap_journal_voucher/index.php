...
<body>
	<div style="margin-top:10px;" align="center"><h1>(THCAP) ใบสำคัญรายวันทั่วไป</h1></div>
	...
	<fieldset><legend>เงือนไขหลัก</legend>
		<table align="center" cellspacing="10px">
			...
			<tr>
				...
				<td><b>ตามเดือน:</b></td>
				<td>
					<select name="month" id="month"><!-- เดือนให้เลือก -->   
	...
	<fieldset><legend>เงือนไขรอง</legend>
	  <table align="center" cellspacing="10px">
	    <tr>
				<td>
	...
	<div id="list_wait_cancel" style="width:80%;margin-top:30px;margin-left:auto;margin-right:auto;"><?php include("../thcap_approve_cancel_voucher/JournalVoucher_cancel_wait.php"); ?></div>
...
$("#Search").click(function(){
	...
	var cancel = "";
	var purpose_idx = $("#voucher_purpose").val(); // รัยค่าเลขประจำจุดประสงค์  ที่ผู้ใช้เลือกมา
	var chk_sel_detail = "";
	var chk_sel_purpose = ""; 
	...
	// ตรวจสอบที่ Check Box ว่ามีการเลือก แสดงรายการที่ยกเลิก/รายการปรับปรุงยกเลิก หรือไม่
	...
	// ตรวจสอบที่ Check Box ว่ามีการเลือกที่จะค้นหา ตามรายละเอียด หรือไม่
	if($("#chk_s_detail").is(':checked')){
		chk_sel_detail = "on"; // เลือก 
	}else{
		chk_sel_detail = "off"; // ไม่เลือก
	}
	
	// ตรวจสอบที่ Check Box ว่ามีการเลือกที่จะค้นหา ตามจุดประสงค์ หรือไม่
	if($("#chk_voucher_purpose").is(':checked')){
		chk_sel_purpose = "on"; // เลือก 
	}else{
		chk_sel_purpose = "off"; // ไม่เลือก
	}
