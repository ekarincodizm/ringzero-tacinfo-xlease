<?php
	...
	foreach ($Data_Arr as $key => $Val){
		...
		{	// กรณีที่ข้อมูลเป็น  ประเภท ของ Tag Element ที่ไม่ต้องการบันทึก
			// no thing	
		}elseif(in_array($Element[1],$Name_Element_In_Main)){ // กรณีที่ฃื่อ Tag ข้อมูล อยู่ในรายการที่จะบันทึกลงใน ตาราง thcap_audit_docs_main  
