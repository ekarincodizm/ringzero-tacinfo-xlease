...
<title>ใบสรุปการตรวจสอบเอกสารรับกลับสำหรับสินเชื่อเช่าซื้อ-ลีสซิ่ง</title>
        ...
        <ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all" >
            ...
            <FORM  id = "frmMain" method="post"  action = "Receive_Doc_Val_cr_0046.php" onsubmit="return Chk_Input_Data_cr_0046()"> 
        		...
        		<div class="ui-tabs-panel ui-widget-content ui-corner-bottom" id="tabs-1">
        			<?php
						include("thcap_cr_0046_Page01.php"); 
        		...
        		<div class="ui-tabs-panel ui-widget-content ui-corner-bottom" id="tabs-2">
        			<?php
						include("thcap_cr_0046_Page02.php"); 
					?>
					<div align="center">
        				<?php
							if(pg_escape_string($_POST["Purpose"]) == "Input")
							{
								?>
									<BR><!-- <input type="submit" VALUE = "บันทึก"/> -->
										<input name = "btn_save" id = "btn_save" type="button" VALUE = "บันทึก" onclick = "Chk_Input_Data_cr_0046()" />		
							<?php	
							}else{
								// nothing
							}
