...
<body>
	<center>
	<h1>ประวัติการยกเลิกใบสำคัญรายวันทั่วไป</h1>
	<table width="95%" border="0" cellSpacing="1" cellPadding="3" align="center" bgcolor="#F0F0F0">
		...
		<?php
		$qry_app = pg_query("select * from v_thcap_temp_voucher_journal_wait_cancel where \"appvStatus\" in('0','1') order by \"appvStamp\" DESC ");
