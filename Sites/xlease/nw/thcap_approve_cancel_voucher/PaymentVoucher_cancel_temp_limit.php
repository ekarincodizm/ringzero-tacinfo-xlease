...
<html>
<head>
	<title>ประวัติการยกเลิกใบสำคัญจ่าย</title>
...
<body>
	<table width="100%" border="0" cellSpacing="1" cellPadding="3" align="center" bgcolor="#F0F0F0">
		<tr bgcolor="#FFFFFF">
			<td colspan="10" align="left" style="font-weight:bold;">ประวัติการยกเลิกใบสำคัญจ่าย 30 รายการล่าสุด<input type="button" value="แสดงประวัติทั้งหมด" onclick="javascript:popU('PaymentVoucher_cancel_temp.php','','toolbar=no,menubar=no,resizable=no,scrollbars=yes,status=no,location=no,width=1400,height=650')" style="cursor:pointer;"></td>
		</tr>
		...
		<?php
		$qry_app = pg_query("select * from v_thcap_temp_voucher_payment_wait_cancel where \"appvStatus\" in('0','1') order by \"appvStamp\" DESC limit 30 ");
		...
		?>
			<td><?php echo $i; ?></td>
			<td align="center"><span onclick="javascript:popU('../thcap_payment_voucher/voucher_channel_detail.php?voucherID=<?php echo $voucherID?>','','toolbar=no,menubar=no,resizable=no,scrollbars=yes,status=no,location=no,width=1000,height=700')" style="cursor:pointer;"><font color="blue"><u><?php echo $voucherID;?></u></font></span></td>
			...
			<td><span onclick="javascript:popU('PaymentVoucher_cancel_detail_view.php?autoID=<?php echo $autoID?>','','toolbar=no,menubar=no,resizable=no,scrollbars=yes,status=no,location=no,width=1000,height=700')" style="cursor:pointer;"><u>ตรวจสอบ</u></span></td>
		</tr>
		<?php
		} //end while
