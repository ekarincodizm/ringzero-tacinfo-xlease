...
$qry_voucherID = pg_query("select \"voucherID\", \"doerRemark\", \"doerName\", \"doerStamp\"
							from \"v_thcap_temp_voucher_journal_wait_cancel\" where \"autoID\" = '$autoID' ");
...
$qry = "select * from v_thcap_temp_voucher_details_journal where \"voucherID\"='$voucherID'";
...
<html>
<head>
    <title>ยกเลิกใบสำคัญรายวันทั่วไป</title>
...
<div style="width:80%;margin-left:auto;margin-right:auto;">
	...
	<div style="margin-top:10px;" align="center"><h1>ยกเลิกใบสำคัญรายวันทั่วไป</h1></div>
<table width="100%">
	<tr >
		<td align="left">
			<div style="margin-top:10px;">
				<table align="left">
					<tr>
						<td align="right"><b>รหัสใบสำคัญรายวันทั่วไป :</b></td>
						<td><a onclick="javascript:popU('../thcap_journal_voucher/voucher_channel_detail.php?voucherID=<?php echo $voucherID; ?>','','toolbar=no,menubar=no,resizable=no,scrollbars=yes,status=no,location=no,width=980,height=550');" style="cursor:pointer;"><font color="red"><u><?php echo $voucherID; ?></a></font></td>
					</tr>
					<tr>
