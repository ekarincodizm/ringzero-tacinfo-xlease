...
<html>
<head>
	<title>ใบสำคัญจ่ายที่รออนุมัติยกเลิก</title>
...
<body>
	<table width="100%" border="0" cellSpacing="1" cellPadding="3" align="center" bgcolor="#F0F0F0">
		<tr bgcolor="#FFFFFF">
			<td colspan="7" align="left" style="font-weight:bold;">ใบสำคัญจ่ายที่รออนุมัติยกเลิก</td>
		</tr>
		...
		<?php
		$qry_app = pg_query("select * from v_thcap_temp_voucher_payment_wait_cancel where \"appvStatus\" = '9' order by \"doerStamp\" ASC ");
		...
		?>
			...
			<td><span onclick="javascript:popU('../thcap_approve_cancel_voucher/PaymentVoucher_cancel_detail.php?autoID=<?php echo $autoID?>','','toolbar=no,menubar=no,resizable=no,scrollbars=yes,status=no,location=no,width=1000,height=700')" style="cursor:pointer;"><u>ตรวจสอบ</u></span></td>
		</tr>
		<?php
		} //end while
