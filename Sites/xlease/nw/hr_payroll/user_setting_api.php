...
if($salary_date_cal_start=='')$salary_date_cal_start=1;
   ...
   $in_qry="Update \"hr_payroll_report\" set
           user_id_slip='$user_id_slip', user_fullname='$user_fullname', user_dep='$user_dep', 
            user_div='$user_div', user_pos='$user_pos', user_start='$user_start', bank_name='$bank_name', 
            comp_name='$comp_name', bank_acc_type='$bank_acc_type', bank_acc_no='$bank_acc_no', salary_type='$salary_type',salary_amt='$salary_amt', 
