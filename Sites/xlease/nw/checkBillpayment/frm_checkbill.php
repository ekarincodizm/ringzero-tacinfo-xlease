...
<form method="post" name="form1" action="process_checkbill.php">
...
<tr>
	...
	<td height="50"><input type="radio" name="result" value="1" checked> ตรวจผ่าน &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="result" value="9"> พบผิดปกติ</td>
</tr>
<tr height="130">
	<td align="right" valign="top"><b>Remark :</b></td>
	<td valign="top"><textarea name="remark" cols="50" rows="5"></textarea></td>
</tr>
<tr>
