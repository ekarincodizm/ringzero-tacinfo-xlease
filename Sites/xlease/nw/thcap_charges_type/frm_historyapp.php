...
<body>
<center><h1>(THCAP) ประวัติการอนุมัติจัดการประเภทค่าใช้จ่าย</h1></center>
<table id="tb_approved" align="center" width="95%" border="0" cellspacing="1" cellpadding="1" bgcolor="#BBBBEE">
	...
	<?php
	$qry_fr=pg_query("select * from account.\"thcap_typePay_temp\" where \"appvStatus1\" <> '9' or \"appvStatus2\" <> '9' order by \"tpAutoID\" DESC ");
