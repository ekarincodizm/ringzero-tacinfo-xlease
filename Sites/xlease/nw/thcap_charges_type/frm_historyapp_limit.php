...
<fieldset style="width:100%">
	<legend>
		<font color="black"><b>ประวัติการอนุมัติ 30 รายการล่าสุด (<a style="color:#0099FF;cursor:pointer;" onclick="javascript:popU('frm_historyapp.php','','toolbar=no,menubar=no,resizable=no,scrollbars=yes,status=no,location=no,width=1400,height=650')"><u>ทั้งหมด</u></a>)</b></font>
	</legend>
<br>
<table id="tb_approved" align="center" width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#BBBBEE">
	...
	<?php
	$qry_fr=pg_query("select * from account.\"thcap_typePay_temp\" where \"appvStatus1\" <> '9' or \"appvStatus2\" <> '9' order by \"tpAutoID\" DESC limit 30 ");
	...
	?>
		...
		<td><span onclick="javascript:popU('frm_approve_showtab.php?id=<?php echo $tpAutoID; ?>&view=v','','toolbar=no,menubar=no,resizable=no,scrollbars=yes,status=no,location=no,width=1000,height=750')" style="cursor: pointer;"><img src="../thcap/images/detail.gif" height="19" width="19" border="0"></span></td>
	<?php
		echo "</tr>";
	} //end while
	if($nub == 0)
	{
		echo "<tr bgcolor=\"#CDC5BF\"><td colspan=12 align=center height=50><b>- ไม่พบข้อมูล -</b></td></tr>";
	}
	else
	{
		echo "<tr bgcolor=\"#CDC5BF\"><td colspan=\"12\"><b>ข้อมูลทั้งหมด $i รายการ</b></td><tr>";
	}
	?>
</table>
</fieldset>
