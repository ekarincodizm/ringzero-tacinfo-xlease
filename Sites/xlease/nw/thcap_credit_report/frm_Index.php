...
<body>
	<div style="margin-top:10px;" align="center"><h1>(THCAP) รายงานใบลดหนี้</h1></div>
	<div style="margin-top:10px; width:60%;margin-left:auto;margin-right:auto;">
	<fieldset><legend>เงือนไขการค้นหา</legend>
		<table align="center" cellspacing="10px">			
			<tr>
				<td><input type="radio" id="search_credit" name="search_type"  value="0" /></td>
				<td><b>ค้นหา รหัส Credit Note:</b></td>
				<td><input type="text" name="s_creditnote" id="s_creditnote"></td>	
			</tr>
			<tr>
	...
	<!--แสดงผลการค้นหา-->	
	<div id="list_credit" style="margin-top:10px;"></div>
</bodY>
</html>
<script>
...
$("#s_creditnote").autocomplete({
        source: " s_credit_note.php",
        minLength:1
});
$("#Search").click(function(){
	var chk = 0;
	var tv = $("#s_creditnote").val();
	...
	if($("#search_credit:checked").val() == "0"){
		if(tv == ""){
			errorMessage += "กรุณาระบุ  Credit Note ที่ต้องการค้นหา \n";
			chk++;
		}
	}
	...
	if(chk == 0){ //ถ้าระบุข้อมูลครบ
		$("#list_credit").load("list_credit.php",{
			txt_dcNoteID:tv,
			s_date:date1,
			s_month:month,
			s_year:year,
...
//เมื่อเลือกเงื่อนไขการค้นหาใหม่ให้เคลียร์ข้อมูลที่ป้อน
