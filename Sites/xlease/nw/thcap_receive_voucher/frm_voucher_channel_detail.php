...
<html>
<head>
    <title>รายละเอียดใบสำคัญรับ</title>
...
<div style="width:80%;margin-left:auto;margin-right:auto;">
	...
	<div style="margin-top:10px;" align="center"><h1>รายละเอียดใบสำคัญรับ</h1></div>
<table width="100%">
	<tr >
		<td align="left">
	...
	<tr>
		<td align="center" colspan="2">
			<input type="button" name="cancel" id="cancel" value="ขอยกเลิก" onclick="javascript:popU('frm_cancel_receive_voucher.php?pop=Y&select_print=<?php echo $voucherID; ?>','','toolbar=no,menubar=no,resizable=no,scrollbars=yes,status=no,location=no,width=1100,height=680')" <?php echo $hidden;?> />
