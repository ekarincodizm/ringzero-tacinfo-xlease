...
<html>
<head>
    <title>(THCAP) รายงานเงินสดประจำวัน  (ทางระบบบดำเนินงาน)</title>
...
{  
	...
	if($("#by_date:checked").val() == "0"){// ค้นหาตาม เลือก วันที่ :
		...
		$("#panel").load("frm_list_show.php?datepicker="+ $("#datepicker").val());
	}
	else{	
			...
			if(chk==0){				
				$('#panel').html('<img src="images/process.gif" border="0" width="32" height="32" alt="กำลังโหลด...">');
				$("#panel").load("frm_list_show_month_year.php?sele_by_year_year="+ $("#sele_by_year_year").val()+
...
<table width="90%" border="0" cellspacing="0" cellpadding="0" align="center">
    <tr>
        <td>
			<div style="text-align:center"><h2>(THCAP) รายงานเงินสดประจำวัน</h2><h3>(ทางระบบบดำเนินงาน)</h3></div>       
			<div>
				<table width="100%">
					<tr>
						<td align="left">
							<input type="button" style="height: 3em; cursor:pointer;" value="ทางระบบบัญชี" onclick="window.location='frm_Index_account.php';">
							<input type="button" style="height: 3em;" value="ทางระบบดำเนินงาน" disabled>
						</td>
						<td align="right">
