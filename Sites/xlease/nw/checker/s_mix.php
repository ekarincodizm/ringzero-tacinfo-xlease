...
$qry_name=pg_query("select * from \"nw_securities\"

where \"numDeed\" like '%$term%' or \"numLand\" like '%$term%' or condobuildingname like '%$term%' or condoregisnum like '%$term%' or \"district\" like '%$term%'");
