...
<table width="900" border="0" cellspacing="0" cellpadding="0" align="center">
    <tr>
		<td>
			<div style="padding-bottom: 10px;text-align:center;"><h2>เพิ่ม Annoucement</h2></div>
			...
			<table width="100%" align="center" border="0" cellSpacing="0" cellPadding="0" align="center" bgcolor="#D0D0D0">
					<form method="post" name="form1" action="frm_annAdd.php">
					<tr height="50" bgcolor="#FFFFFF">
						<td colspan="5" align="right"><input type="submit" value="เพิ่มประกาศ"><input type="button" value="ตั้งค่าผู้รับข่าวสาร" onclick="window.location='frm_setupuser.php'"><input type="button" value="  Close  " onclick="javascript:window.close();"></td>
					</tr>
					</form>
				</table>
				...
				<table width="100%" align="center" border="0" cellSpacing="1" cellPadding="3" align="center" bgcolor="#D0D0D0" class="sort-table">
					...
					<?php
						if($credit_search==""){
							...
							$query=pg_query("select * from \"nw_annoucement\" a
							left join \"Vfuser\" b on a.\"annAuthor\"=b.id_user
							where \"annTitle\" like '%$credit_search%' and \"typeAnnId\"='$typeAnnId2' order by \"annId\" ");
						}
						...
						while($result=pg_fetch_array($query)){
							...
							echo "<tr bgcolor=#FFFFFF>";
								...
								if($statusApprove=="f"){
									echo "<td align=center><a href=\"frm_annEdit.php?annId=$annId\"><img src=\"images/edit.png\" width=16 height=16 style=\"cursor:pointer;\"></a></td>";
								}else{
									echo "<td align=center>แก้ไขไม่ได้</te>";
								}
							echo "</tr>";
							$i++;
						}
