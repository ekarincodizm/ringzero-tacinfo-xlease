...
<body>
<div id="swarp" style="width:900px; height:auto; margin-left:auto; margin-right:auto;">
<div class="style2" id="super_head" style="padding-left:10px; height:90px; width:900px;"><span class="style2" style="padding-left:10px; height:60px; width:800px; "><div style="width:90px; float:left;"><img src="../../images/<?php echo $file_namepic; ?>" width="80" height="80" /></div><div style="padding-top:20px;"><span><?php echo $_SESSION["session_company_name"]; ?></span><br /><?php echo $_SESSION["session_company_thainame"]; ?></div></div>
...
<div class="style1" id="menu" style="height:30px; padding-left:10px; padding-top:10px; padding-right:10px;">
	...
	<select name="ad_annId" id="ad_annId" onChange="this.form.submit();">  
		...
		$qry_menu=pg_query("select * from \"nw_annoucement\" where \"statusApprove\"='t' and \"statusCancel\" = 'f' order by \"keyDate\" DESC");
...
<form method="post" name="form2" action="process_annEdit_newbie_usermenu.php">
<div class="style1" id="menu" style="height:30px; padding-left:10px; padding-top:0px; padding-right:10px;">
<?php 
if($ad_annId != ""){
	$newbie_seesql=pg_query("select * from \"nw_annouceuser_newbie\" where \"annId\"='$ad_annId' and \"statusAccept\" = '1'");
...
<span id="textnewemp" name="textnewemp">|| ประกาศให้พนักงานใหม่ทราบในกลุ่มผู้ใช้ : 
...
<div id="contentpage" style="height:auto;">
 ...
 <div class="style5" style="width:auto;  padding-left:10px;" align="center">
  <?php
  if($a_gp==""){
  ...
  <tr>
    <td colspan="8" style="text-align:center;height:50px;">
		...
		<input type="submit"  value="บันทึก" onclick="return checkdata()"/><input type="button" value="BACK" onclick="window.location='frm_annEdit_newbie.php'" />
	</td>
  </tr>
</table>
</div>
