...
//popup ที่ รายละเอียดเพิ่มเติม โดยนำมาจาก  รายละเอียดการคืนเงิน 
function detailapp_dncn(idapp,statusapp){	
		$('body').append('<div id="dialog"></div>');
		$('#dialog').load('../thcap_dncn/popup_app.php?idapp='+idapp+'&appstate='+statusapp);
		$('#dialog').dialog({
...
<form name="frm"  method="post" target="_blank">
	<div style="margin-top:10px;"align="center">
		<table cellpadding="5" cellspacing="0" border="0" width="80%" bgcolor="#F0F0F0" align="center">
			<tr bgcolor="white">
				<td colspan="2" align="left"><font size="3" color="blue"><b>รายงานใบเพิ่มหนี้</b></font></td>
			...
			<?php 
				...
				if($num_row>0){
					...
					if($subjectStatus=='1'){$subjectStatus="{โปรดกำหนดข้อความที่จะให้แสดง}";}
					...
					if($i%2==0){	
						...
						echo "<tr class=\"event\" >";
							...
							?><td align="center"><img src="images/detail.gif" width="19" height="19" style="cursor:pointer;" 
								onclick="detailapp_dncn('<?php echo $dcNoteID; ?>','0');"></td>	
							<?php 
							echo "</tr>"; 			
					}//จบ while
				}else{
