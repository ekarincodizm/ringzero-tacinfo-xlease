...
<html>
<head>
    <title>(THCAP) แก้ไขรายละเอียดประกันภัย</title>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			$("#contractID").autocomplete({
				source: "s_contractID_car_edit.php",
				minLength:1,
				delay:800
			});
		});
		...
		function searchContract()
		{
			...
			$("#showContract").load("frm_contractDetail.php?contractID="+$("#contractID").val()+"&execution=edit");
		}
	</script>
 
</head>
<body>
	<div style="text-align:center;"><h2>(THCAP) แก้ไขรายละเอียดประกันภัย</h2></div>
	<table width="90%" border="0" cellspacing="0" cellpadding="0" align="center">
		<tr>
			<td align="center">
				<fieldset><legend><B>ค้นหาเลขที่สัญญา</B></legend>
					 เลขที่สัญญา/เลขตัวถัง/ทะเบียนรถ :
