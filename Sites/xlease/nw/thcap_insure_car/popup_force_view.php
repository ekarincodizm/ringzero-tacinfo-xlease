...
$appvName = pg_fetch_result($qr,18); // ชื่อผู้อนุมัติ
$appvStamp = pg_fetch_result($qr,19); // วันเวลาที่อนุมัติ
$appvStatus = pg_fetch_result($qr,20); // ผลการอนุมัติ
$appvNote = pg_fetch_result($qr,21); // หมายเหตุการอนุมัติ
...
<html>
<head>
    <title>รายละเอียด ประกันภัย ภาคบังคับ (พรบ.)</title>
...
<body>
	<center>
		<div style="text-align:center;"><h2>รายละเอียด ประกันภัย ภาคบังคับ (พรบ.)</h2></div>
