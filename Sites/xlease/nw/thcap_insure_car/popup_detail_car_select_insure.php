...
<body>
	<center>
		...
		<br/><br/>
		<input type="button" value="บันทึก ข้อมูล ประกันภัย ภาคบังคับ (พรบ.)" style="cursor:pointer;" <?php echo $can_request_force; ?> onClick="window.location='frm_force_add.php?contractID=<?php echo $contractID; ?>&assetDetailID=<?php echo $assetDetailID; ?>';" />
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="button" value="บันทึก ข้อมูล ประกันภัย ภาคสมัครใจ" style="cursor:pointer;" <?php echo $can_request_unforce; ?> onClick="window.location='frm_unforce_add.php?contractID=<?php echo $contractID; ?>&assetDetailID=<?php echo $assetDetailID; ?>';" />
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
