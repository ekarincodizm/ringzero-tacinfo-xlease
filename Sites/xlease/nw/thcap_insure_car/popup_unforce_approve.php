...
$InsID = pg_fetch_result($qr,21); // เลขที่ของกรมธรรม์
$InsDate = pg_fetch_result($qr,22); // วันที่รับกรมธรรม์
$NetPremium = pg_fetch_result($qr,23); // เบี้ยสุทธิ
...
<body>
	<center>
		<div style="text-align:center;"><h1>อนุมัติ ประกันภัย ภาคสมัครใจ</h1></div>
