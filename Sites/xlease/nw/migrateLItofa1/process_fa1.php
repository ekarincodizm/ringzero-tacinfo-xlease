...
$qryname = mysql_query("SELECT * FROM $db1.vcustomerbycontract a
inner join $db1.vcustomerdetail b on a.miscellaneous_code=b.CusID
where a.contract_loans_code like 'LI%' and a.miscellaneous_code like 'CUS%'");
...
while($resname=mysql_fetch_array($qryname)){
	...
	if($statushas==0){ 
		...
		$insert_temp="INSERT INTO \"Customer_Temp\"(
					...
					\"N_OT_DATE\",\"N_BY\", \"N_OCC\", \"N_ContactAdd\", \"N_STATE\", \"A_FIRNAME_ENG\", \"A_NAME_ENG\", \"A_SIRNAME_ENG\", 
							\"A_NICKNAME\", \"A_STATUS\", \"A_REVENUE\", \"A_EDUCATION\", \"A_COUNTRY\", \"A_MOBILE\", \"A_TELEPHONE\", \"A_EMAIL\",\"A_BIRTHDAY\",\"A_SEX\",addr_country)
				VALUES ('$cus_sn','$add_user','$add_date','000','$add_date','1','0',$A_FIRNAME, $A_NAME, $A_SIRNAME, $A_PAIR, $A_NO,
