...
function FPDF_SLIP($orientation='L', $unit='mm', $format='a4h')
{
	//Some checks
	$this->_dochecks();
	//Initialization of properties
	...
	elseif($unit=='in')
		...
		$this->Error('Incorrect unit: '.$unit);
	//Page format
	$this->PageFormats=array('a3'=>array(841.89,1190.55), 'a4'=>array(595.28,841.89), 'a4h'=>array(578.27,396.85), 'a5'=>array(420.94,595.28),
		'letter'=>array(612,792), 'legal'=>array(612,1008));
	if(is_string($format))
		$format=$this->_getpageformat($format);
	$this->DefPageFormat=$format;
...
{
	$txt=iconv('UTF-8', 'TIS-620', $txt); // ทดลองว่าภาษาไทยใช้ได้หรือไม่
	//Output a cell
	$k=$this->k;
