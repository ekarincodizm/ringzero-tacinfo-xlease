...
<body >
<?php
$query_main = pg_query("select * from public.\"thcap_changeRate_temp\" where \"tempID\" = '$tempID' ");
...
if($appvID != "")
{
	...
	while($result_name = pg_fetch_array($qry_name))
	{
		$appvFullname = $result_name["fullname"]; // ชื่อของผู้ที่ทำรายการ
	}
}
?>
...
<tr>
	<td align="right">ผู้ทำรายการขอปรับอัตราดอกเบี้ย : </td>
	<td><?php echo $doerFullname; ?></td>
</tr>
<tr>
	<td align="right">วันเวลาที่ทำรายการขอปรับอัตราดอกเบี้ย : </td>
	<td><?php echo $doerStamp; ?></td>
</tr>
<tr>
	<td align="right">ผู้ทำรายการอนุมัติ : </td>
	<td><?php echo $appvFullname; ?></td>
</tr>
<tr>
	<td align="right">วันเวลาที่ทำรายการอนุมัติ : </td>
...
<?php
	...
	$qrySearchFile = pg_query("select * from public.\"thcap_changeRate_file_temp\" where \"tempID\" = '$tempID' ");
...
<tr>
	...
	<td><textarea Readonly><?php echo $app_note; ?></textarea></td>
</tr>	
<tr>
	<td colspan="2" align="center"><input type="button" value="ปิด" onclick="javascript:window.close();"></td>
</tr>
<tr>
	<td><br></td>
</tr>	
