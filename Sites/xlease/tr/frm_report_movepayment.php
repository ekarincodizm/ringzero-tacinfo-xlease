...
<div id="login"  style="height:50px; width:800px; text-align:left; margin-left:auto; margin-right:auto;">
  ...
  <form name="frm_ch" method="post" action="list_movetranspay.php">
  เลือกวันที่ทำรายการย้าย billpaymnet <input name="qryDate" type="text" readonly="true" value="<?php echo date("Y/m/d"); ?>"/>
