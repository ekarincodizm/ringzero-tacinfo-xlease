...
$sendid = pg_escape_string($_POST["sendid"]); // ค่าที่ส่งมาจากเมนู "สัญญาเช่าซื้อที่ยังไม่ล็อก"
...
$(document).ready(function(){
    ...
    $('#btn1').click(function(){
        ...
        $("#panel").load("frm_confrim_lock.php?IDNO="+ brokenstring[0]+"&statuslock=Lock");
    });
...
<div id="login"  style="height:50px; width:800px; text-align:left; margin-left:auto; margin-right:auto;">
  ...
  ตรวจสอบ IDNO
	...
	<?php
	if($sendid != "")
	{ // ถ้ามาจากเมนู สัญญาเช่าซื้อที่ยังไม่ล็อก
	?>
		<input type="button" value="กลับไปเลือก สัญญาเช่าซื้อที่ยังไม่ล็อก" onClick="window.location='../nw/fp_not_lock/frm_Index.php'"/>
	<?php
	}
	?>
...
<script>
	var sendid = '<?php echo $sendid; ?>';
	if(sendid != '')
	{
		document.getElementById("idno_names_m").value = sendid;
		var sendbrokenstring = sendid.split("#");
        $("#panel").load("frm_confrim_lock.php?IDNO="+ sendbrokenstring[0]+"&statuslock=Lock");
	}
</script>
