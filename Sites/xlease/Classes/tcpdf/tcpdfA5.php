...
class TCPDF {
	 ...
	 */
	public function __construct($orientation='L', $unit='mm', $format='A5', $unicode=true, $encoding='UTF-8', $diskcache=false) {
	...
	public function getPageSizeFromFormat($format) {
		...
		switch (strtoupper($format)) {
			...
			case 'A5' : {$pf = array(  595.276,  419.528); break;}
			...
			default: {$pf = array(  595.276,  419.528); break;}
		}
		return $pf;
	}
