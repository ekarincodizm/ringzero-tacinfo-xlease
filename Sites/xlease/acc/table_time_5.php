...
?>
        ...
        <td align="right"><?php echo number_format( ($aroverdue-$uroverdue) - ((($aroverdue-$uroverdue)*$security)*$reserve),2); ?></td>
        <td align="right"><?php echo number_format( ($arnextydue-$urnexty) - ((($arnextydue-$urnexty)*$security)*$reserve),2); ?></td>
        <td align="right"><?php echo number_format( ($arotherydue-$urothery) - ((($arotherydue-$urothery)*$security)*$reserve),2); ?></td>
        <td align="right"><?php echo number_format( ($artotal-$urtotal) - ((($artotal-$urtotal)*$security)*$reserve),2); ?></td>
    </tr>
...
<tr bgcolor="#ffffff" style="font-size:11px; font-weight:bold;">
    <td align="left" colspan="2"><a href="table_time_5_print.php?yy=<?php echo $yy; ?>" target="_blank"><img src="icoPrint.png" border="0" width="17" height="14"> พิมพ์รายงาน</a></td>
