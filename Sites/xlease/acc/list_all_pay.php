...
<div id="login"  style="height:50px; width:800px; text-align:left; margin-left:auto; margin-right:auto;">
  ...
  <tr style="background-color:#E9ECD5">
    <td colspan="5" style="padding-left:10px; padding-top:5px; padding-bottom:5px;"><a href="pdf_print_pay.php?mmode=<?php echo $f_mode; ?>&myear=<?php echo $f_year; ?>&mtype=<?php echo $f_type; ?>"><img src="icoPrint.png" border="0" /></a> <span class="style6">&lt;-<a href="pdf_printall_pay.php?myear=<?php echo $f_year; ?>&mtype=<?php echo $f_type; ?>">พิมพ์ใบสำคัญจ่าย</a> </span></td>
    </tr>
  ...
  <?php
  $qry_m=pg_query("select \"acb_date\",\"acb_id\",\"acb_detail\" from account.\"AccountBookHead\" where (EXTRACT(YEAR FROM acb_date)='$f_year')  AND (type_acb='$f_type') AND (cancel=false) ORDER BY acb_id ");
