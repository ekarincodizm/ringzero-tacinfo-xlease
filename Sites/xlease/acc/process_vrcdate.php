...
//ACTIONLOG
		$sqlaction = pg_query("INSERT INTO action_log(id_user, action_desc, action_time) VALUES ('$user_id', '(TAL) ออกใบกำกับประจำวัน', '$add_date')");
//ACTIONLOG---		
...
for($i=0;$i<count($_POST["chk_vrec"]);$i++)
 {
   
   
   $recid=trim(pg_escape_string($_POST["chk_vrec"][$i]));
