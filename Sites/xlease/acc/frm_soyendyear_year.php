...
<input name="button" type="button" onclick="window.location='frm_soyendyear_year.php'" value="รายงานรับรู้รายได้ประจำปี" disabled>
<input name="button" type="button" onclick="window.location='frm_soy_run.php'" value="Run รับรู้รายได้ใหม่">
</div>
<div style="float:right"><input type="button" value="  Close  " onclick="javascript:window.close();"></div>
<div style="clear:both;"></div>
 
<fieldset><legend><b>รายงานรับรู้รายได้ประจำปี</b></legend>
