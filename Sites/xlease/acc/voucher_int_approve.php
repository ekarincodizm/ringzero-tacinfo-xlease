...
<div style="float:left"><input name="button" type="button" value="รออนุมัติ" class="ui-button" disabled /><input name="button" type="button" class="ui-button" onclick="window.location='voucher_int_approve_list.php'" value="อนุมัติแล้ว" /></div>
