...
<div id="login"  style="height:50px; width:800px; text-align:left; margin-left:auto; margin-right:auto;">
  ...
  <?php
   ...
   $aa_id=pg_escape_string($_POST["h_id"]);
  ?>
  ...
  <tr style="background-color:#E9ECD5">
    <td colspan="5" style="padding-left:10px; padding-top:5px; padding-bottom:5px;"><a href="pdf_print_pay.php?mmode=<?php echo $f_mode; ?>&myear=<?php echo $f_year; ?>&mtype=<?php echo $f_type; ?>"><img src="icoPrint.png" border="0" /></a> <span class="style6">&lt;-<a href="pdf_id_pay.php?aid=<?php echo $aa_id; ?>">พิมพ์ใบสำคัญจ่าย</a> <?php echo $aa_id; ?> </span></td>
    </tr>
  ...
  <?php
  $qry_m=pg_query("select \"acb_date\",\"acb_id\",\"acb_detail\" from account.\"AccountBookHead\" where acb_id='$aa_id' ");
