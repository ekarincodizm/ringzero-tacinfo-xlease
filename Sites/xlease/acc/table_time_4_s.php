...
$tt_custyear = $custyear;
    ...
    $st_aroverdue += (($aroverdue-$uroverdue)*$security)*$reserve;
    $st_arnextydue += (($arnextydue-$urnexty)*$security)*$reserve;
    $st_arotherydue += (($arotherydue-$urothery)*$security)*$reserve;
    $st_artotal += (($artotal-$urtotal)*$security)*$reserve;
    $st_aroutstanding += (($aroutstanding-$urtotal)*$security)*$reserve;
...
<tr bgcolor="#ffffff" style="font-size:11px; font-weight:bold;">
    <td align="right"><a href="table_time_4_s_print.php?yy=<?php echo $yy; ?>" target="_blank"><img src="icoPrint.png" border="0" width="17" height="14"> พิมพ์รายงาน</a> | รวมทั้งสิ้น</td>
