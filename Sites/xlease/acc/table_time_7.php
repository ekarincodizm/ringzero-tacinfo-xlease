...
<table width="100%" border="0" cellSpacing="1" cellPadding="2" align="center" bgcolor="#F0F0F0">
    <tr style="font-weight:bold;" valign="middle" bgcolor="#79BCFF">
        ...
        <td align="center" colspan="6">Un-Realized</td>
    </tr>
    <tr style="font-weight:bold;" valign="middle" bgcolor="#79BCFF">
...
?>
        ...
        <td align="right"><?php echo number_format($uroverdue,2); ?></td>
        <td align="right"><?php echo number_format($urnexty,2); ?></td>
        <td align="right"><?php echo number_format($urothery,2); ?></td>
        <td align="right"><?php echo number_format($urtotal,2); ?></td>
    </tr>
...
<tr bgcolor="#ffffff" style="font-size:11px; font-weight:bold;">
    <td align="left" colspan="1"><a href="table_time_7_print.php?yy=<?php echo $yy; ?>" target="_blank"><img src="icoPrint.png" border="0" width="17" height="14"> พิมพ์รายงาน</a></td>
