...
<div style="float:left"><input type="button" value="บันทึกเอง" class="ui-button" onclick="javascript:window.location='add_acc_manual_aj.php';"><input type="button" value="ใช้สูตรทางบัญชี" onclick="javascript:window.location='add_acc_formula_aj.php';" class="ui-button" disabled></div>
<div style="float:right"><input type="button" value="  Close  " onclick="javascript:window.close();" class="ui-button"></div>
<div style="clear:both;"></div>

<fieldset><legend><B>ใช้สูตรทางบัญชี - AJ</B></legend>
