...
<div style="float:left"><input name="button" type="button" class="ui-button" onclick="window.location='voucher_int_approve.php'"  value="รออนุมัติ" /><input name="button" type="button" class="ui-button" value="อนุมัติแล้ว" disabled /></div>
...
?>
<tr>
    <td align="center"><input name="button" type="button" class="ui-button" value="พิมพ์"
    onclick="javascript:window.open('voucher_int_approve_list_pdf.php' , 'p91a2gb4w1r4a164','menuber=no,toolbar=yes,location=no,scrollbars=no, status=no,resizable=no,width=800,height=600')" /></td>
    <td colspan="7"></td>
</tr>
<?php
}else{
