...
$('#btnsort2').click(function(){
    $("#showpanel").empty();
    $("#showpanel").html('<img src="../images/progress.gif" border="0" width="32" height="32" alt="กำลังโหลด...">');
    $("#showpanel").load("frm_year_2009_panel.php?sort=overdue&datepicker="+ $("#datepicker").val());
});
</script>
...
if($sort == "custyear"){
    $qry_name=pg_query("SELECT * FROM account.\"V2009EndYear\" where \"acclosedate\"='$datepicker' ORDER BY custyear,idno ASC ");
}elseif($sort == "overdue"){
    $qry_name=pg_query("SELECT * FROM account.\"V2009EndYear\" where \"acclosedate\"='$datepicker' ORDER BY overdue DESC,custyear,idno ASC ");
}
...
?>
    ...
    <tr bgcolor="#ffffff" style="font-size:11px;">
        ...
        <td align="right" colspan="13"><a href="frm_year_2009_pdf.php?yy=<?php echo "$datepicker";?>&sort=<?php echo "$sort"; ?>" target="_blank"><img src="icoPrint.png" border="0" width="17" height="14" alt=""> <b>พิมพ์รายงาน</b></a></td>
    </tr>
<?php
}else{
?>
