...
<html>
<head>
	<title>ประวัติการอนุมัติยกเลิกเงินโอนนอกระบบ 30 รายการล่าสุด</title>
...
<fieldset style="width:100%">
	<legend><font color="black"><b>ประวัติการอนุมัติยกเลิกเงินโอนนอกระบบ 30 รายการล่าสุด (<a style="color:#0099FF;cursor:pointer;" onclick="javascript:popU('frm_historyAccDel_all.php','','toolbar=no,menubar=no,resizable=no,scrollbars=yes,status=no,location=no,width=1400,height=650')"><u>ทั้งหมด</u></a>)</font></b></font></legend>
	<br>
	<table align="center" width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#BBBBEE">
		...
		$query = pg_query("select CASE WHEN b.\"amt\" is null THEN c.\"amt\" ELSE b.\"amt\" END,
							...
							order by \"appvStamp\" DESC limit 30 ");
