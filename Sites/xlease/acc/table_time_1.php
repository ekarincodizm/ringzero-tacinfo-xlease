...
<input name="button" type="button" onclick="window.location='table_time_1.php?p=1&yy=<?php echo $yy; ?>'" value="แสดงเป็นรายบุคคล" <?php if($p==1) { echo "disabled"; }?> />
<input name="button" type="button" onclick="window.location='table_time_1_s.php?p=2&yy=<?php echo $yy; ?>'" value="แสดงเป็นสรุปประจำปีลูกหนี้" <?php if($p==2) { echo "disabled"; }?> />
</div>
...
<table width="100%" border="0" cellSpacing="1" cellPadding="2" align="center" bgcolor="#F0F0F0">
    <tr style="font-weight:bold;" valign="middle" bgcolor="#79BCFF">
        ...
        <td align="center" colspan="5">จำนวนงวดของ</td>
        <td align="center" rowspan="2">ค่างวด</td>
        <td align="center" colspan="4">Account Receivable</td>
    </tr>
    <tr style="font-weight:bold;" valign="middle" bgcolor="#79BCFF">
        <td align="center">Paid</td>
        <td align="center">ค้าง</td>
...
<tr bgcolor="#ffffff" style="font-size:11px; font-weight:bold;">
    <td colspan="7"></td>
    <td align="right"><?php echo number_format($s_monthly,2); ?></td>
...
?>
        ...
        <td align="center"><?php echo $nextydue; ?></td>
        <td align="center"><?php echo $otherydue; ?></td>
        <td align="center"><?php echo $totaldue; ?></td>
        <td align="right"><?php echo number_format($monthly,2); ?></td>
        <td align="right"><?php echo number_format($aroverdue,2); ?></td>
        <td align="right"><?php echo number_format($arnextydue,2); ?></td>
        <td align="right"><?php echo number_format($arotherydue,2); ?></td>
        <td align="right"><?php echo number_format($artotal,2); ?></td>
    </tr>
...
<tr bgcolor="#ffffff" style="font-size:11px; font-weight:bold;">
    <td align="left" colspan="2"><a href="table_time_1_print.php?yy=<?php echo $yy; ?>" target="_blank"><img src="icoPrint.png" border="0" width="17" height="14"> พิมพ์รายงาน</a></td>
    <td align="right" colspan="5">รวมทั้งสิ้น</td>
    <td align="right"><?php echo number_format($s_monthly_all,2); ?></td>
