...
<div id="login"  style="height:50px; width:800px; text-align:left; margin-left:auto; margin-right:auto;">
  ...
  <tr style="background-color:#F5F7E1; padding:2px;">
    <td colspan="2" style="padding: 3px 3px 3px 3px;"><div align="center"><strong>ผูกสูตรทางบัญช</strong>ี</div></td>
  ...
  <tr style="background-color:#DEE7BE; padding:2px;" >
	...
	<?php
	$sql_fm=pg_query("select * from account.\"FormulaID\" ");
	while($res_fm=pg_fetch_array($sql_fm))
	{
	?>
  <tr id="tr<?php echo $res_fm["fm_id"]; ?>"  style="background-color:#EDF1DA;">
    <td style="padding-left:3px;"><?php echo $res_fm["fm_id"]; ?></td>
    <td style="padding-left:3px;"><?php echo $res_fm["fm_name"]; ?></td>
    <td><div align="center">
    <button onclick="window.location='frm_edit_fmacc.php?fmID=<?php echo $res_fm["fm_id"]; ?>&fmname=<?php echo $res_fm["fm_name"]; ?>'">แก้ไขสูตร</button></div></td>
    <td><div align="center"><a href="JavaScript:if(confirm('Are you delete'))doCallAjax('<?php echo $res_fm["fm_id"]; ?>');">Del</a></div></td>
  </tr>
   <?php
   }
   ?>
