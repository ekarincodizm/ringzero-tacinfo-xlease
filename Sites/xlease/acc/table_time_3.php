...
<input name="button" type="button" onclick="window.location='table_time_3.php?p=1&yy=<?php echo $yy; ?>'" value="แสดงเป็นรายบุคคล" <?php if($p==1) { echo "disabled"; }?> />
<input name="button" type="button" onclick="window.location='table_time_3_s.php?p=2&yy=<?php echo $yy; ?>'" value="แสดงเป็นสรุปประจำปีลูกหนี้" <?php if($p==2) { echo "disabled"; }?> />
</div>
...
<table width="100%" border="0" cellSpacing="1" cellPadding="2" align="center" bgcolor="#F0F0F0">
    <tr style="font-weight:bold;" valign="middle" bgcolor="#79BCFF">
        ...
        <td align="center" colspan="4">A/C Receivable Deducted Un-realize</td>
    </tr>
    <tr style="font-weight:bold;" valign="middle" bgcolor="#79BCFF">
...
?>
        ...
        <td align="right"><?php echo number_format(($aroverdue-$uroverdue),2); ?></td>
        <td align="right"><?php echo number_format(($arnextydue-$urnexty),2); ?></td>
        <td align="right"><?php echo number_format(($arotherydue-$urothery),2); ?></td>
        <td align="right"><?php echo number_format(($artotal-$urtotal),2); ?></td>
    </tr>
...
<tr bgcolor="#ffffff" style="font-size:11px; font-weight:bold;">
    <td align="left" colspan="2"><a href="table_time_3_print.php?yy=<?php echo $yy; ?>" target="_blank"><img src="icoPrint.png" border="0" width="17" height="14"> พิมพ์รายงาน</a></td>
