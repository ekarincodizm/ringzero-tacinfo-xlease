...
<div style="float:left"><input type="button" value="เงินโอนไม่ผ่าน Bill Payment" class="ui-button" onclick="window.location='cash_no_bill.php'" disabled><input type="button" value="ตัดรายการเงิน" class="ui-button" onclick="window.location='cash_elt.php'"></div>
<div style="float:right">&nbsp;</div>
<div style="clear:both"></div>

<fieldset><legend><B>เงินโอนไม่ผ่าน Bill Payment</B></legend>
...
<?php
$qry_bank=pg_query("select \"bankname\", \"bankno\" from \"bankofcompany\" ORDER BY bankofcompany.accno ASC");
...
<b>วันที่โอน</b> : <input name="datepick" id="datepick" type="text" readonly="true" size="15" style="text-align:center;" value="<?php echo nowDate(); ?>" 
onchange="JavaScript:chkDate();"><input name="btndate" id="btndate" type="button" onclick="displayCalendar(document.f_list.datepick,'yyyy-mm-dd',this);" value="ปฏิทิน"></div>
