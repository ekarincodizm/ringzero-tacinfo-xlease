...
$qry_name=pg_query("SELECT \"acclosedate\" FROM account.\"V2009EndYear\" where \"acclosedate\"='$yy' ORDER BY \"idno\" ASC ");
...
if($sort == "custyear"){
    $qry_name=pg_query("SELECT * FROM account.\"V2009EndYear\" where \"acclosedate\"='$yy' ORDER BY custyear,idno ASC ");
}elseif($sort == "overdue"){
    $qry_name=pg_query("SELECT * FROM account.\"V2009EndYear\" where \"acclosedate\"='$yy' ORDER BY overdue DESC,custyear,idno ASC ");
}
