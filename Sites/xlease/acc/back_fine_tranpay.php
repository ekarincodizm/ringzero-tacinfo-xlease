...
$(document).ready(function(){
    $('#btn00').click(function(){
        ...
        $("#panel").load("back_fine_tranpay_panel.php?datepicker="+ $("#datepicker").val() );
...
<fieldset><legend><B>ปรับรายการ Tranpay ย้อนหลัง</B></legend>

<div align="center">

<div class="ui-widget">
<p align="center">
<label for="birds"><b>เลือกวันที่</b></label>
