...
$qry_name=pg_query("select \"IDNO\", \"full_name\", \"C_REGIS\", \"CusID\"
					from \"UNContact\" WHERE \"full_name\" LIKE '%$term%' OR \"IDNO\" LIKE '%$term%' OR \"C_REGIS\" LIKE '%$term%' ORDER BY \"IDNO\" ASC");
