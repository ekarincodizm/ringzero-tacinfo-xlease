...
if($CoPayInsReady == 't'){
    if(!empty($remark)){
        ...
        $in_sql="UPDATE \"insure\".\"InsureUnforce\" SET \"Remark\"='$remark',\"Cancel\"='TRUE' WHERE \"InsUFIDNO\"='$InsUFIDNO'";
...
<br><br>
<input type="button" value="  Back  " onclick="location.href='frm_cancel_unforce.php'">
