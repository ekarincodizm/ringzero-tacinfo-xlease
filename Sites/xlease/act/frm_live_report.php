...
?>
        ...
        <td align="center"><?php echo "$InsLIDNO"; ?></td>
...
echo "<tr bgcolor=#79BCFF> <td align=left><b>รวมทั้งหมด $nub_all รายการ</b></td> <td align=center><b><a href=\"frm_live_report_pdf.php\" target=_blank><img src=\"icoPrint.png\" border=\"0\" width=\"17\" height=\"14\"> พิมพ์</a></b></td> <td colspan=6 align=right><b>ผลรวมทั้งสิ้น</b></td> <td align=right><b>".number_format($sum_premium_all,2)."</b></td> <td align=right><b>".number_format($sum_outstanding_all,2)."</b></td></tr>";
?>    
