...
<div style="float:left"><input type="button" value="  กลับ  " class="ui-button" onclick="window.location='old_receipt2.php'"></div>
<div style="float:right"><input type="button" value="  Close  " class="ui-button" onclick="javascript:window.close();"></div>
<div style="clear:both;"></div>

<fieldset><legend><B>ตัดใบเสร็จประกันเก่า - พรบ.</B></legend>
...
$query=pg_query("select * from \"FOtherpay\" WHERE \"IDNO\"='$idno' AND \"O_Type\"='103' ORDER BY \"O_DATE\" ASC");
...
?>
    <td align="center"><input type="radio" name="chk" id="chk" value="<?php echo $O_RECEIPT; ?>" <?php if(!empty($RefAnyID) || $RefAnyID!="") echo "disabled"; ?>></td>
