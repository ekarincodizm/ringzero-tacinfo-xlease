...
<tr>
	...
	<div class="wrapper">
	<?php
	$qry_in=pg_query("select * from \"insure\".\"InsureUnforce\" WHERE (\"InsUFIDNO\"='".pg_escape_string($_GET[InsUFIDNO])."')");
	...
	?>
		<table width="100%" border="0" cellSpacing="0" cellPadding="8" align="left">
			<tr align="left">
				...
				<td width="80%" colspan="3" class="text_gray"><?php echo $InsUFIDNO; ?></td>
			</tr>
			<tr align="left">
