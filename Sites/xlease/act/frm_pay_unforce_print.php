...
$qry_if=pg_query("select \"Company\" from \"insure\".\"InsureUnforce\" WHERE \"CoPayInsID\"='$payid' ");
...
$gmm=iconv('UTF-8','windows-874',"ประกันภัยภาคสมัครใจ - ".$InsFullName);
$pdf->Text(6,26,$gmm);
...
$i = 1;
$j = 0;                           
$qry_if=pg_query("select * from \"insure\".\"InsureUnforce\" WHERE \"CoPayInsID\"='$payid' AND \"Cancel\"='FALSE' ORDER BY \"InsID\",\"InsUFIDNO\" ASC");
...
$pdf->MultiCell(45,4,$s_name,0,'L',0);
...
$pdf->SetXY(125,$cline); 
$s_asset_regis=iconv('UTF-8','windows-874',$Kind);
