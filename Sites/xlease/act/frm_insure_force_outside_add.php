...
$in_sql="insert into \"insure\".\"InsureForce\" (\"InsFIDNO\",\"CusID\",\"CarID\",\"InsID\",\"InsMark\",\"Company\",\"StartDate\",\"EndDate\",\"Code\",\"Capacity\",\"Premium\",\"NetPremium\",\"Vat\",\"TaxStamp\",\"Discount\",\"CollectCus\",\"DoDate\") values  ('$gen_insid','$get_cusid','$get_carid','$insid','$insmark','$company','$date_start','$date_end','$code','$capa','$gpremium','$pieces[0]','$pieces[2]','$pieces[1]','$discount','$col_cus','$nowdate')";
if($result=pg_query($in_sql)){
    $insert_status4 = "Insert InsureForce Success";
}else{
    $insert_status4 = "Insert InsureForce Error : ".$result;
}
...
<div align="center"><br><input name="button" type="button" onclick="window.location='frm_insure_force_outside.php'" value=" กลับ " /></div>
        </td>
    </tr>
    <tr>
