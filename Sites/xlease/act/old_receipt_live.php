    ...
    <td>        
		...
		<div align="center">
			<div class="ui-widget">
				...
				<?php
				$query=pg_query("select * from insure.\"VInsLiveDetail\" WHERE \"outstanding\"<>'0' ORDER BY \"IDNO\" ASC");
				while($resvc=pg_fetch_array($query)){
					$InsLIDNO = $resvc['InsLIDNO'];
					$IDNO = $resvc['IDNO'];
				...
				?>
					...
					<td align="center"><input type="button" name="btn1" value="ทำรายการนี้" onclick="window.location='old_receipt_live_otherpay.php?idno=<?php echo $IDNO; ?>&id=<?php echo $InsLIDNO; ?>';"></td>
				</tr> 
				<?php
				}
				?>
