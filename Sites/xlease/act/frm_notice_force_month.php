...
while($res_inf=pg_fetch_array($qry_inf)){
    ...
    $summary = 0;
    $qry_if=pg_query("select \"Company\", \"IDNO\", \"StartDate\", \"InsFIDNO\", \"InsID\", \"Premium\" from \"insure\".\"InsureForce\" WHERE \"Company\" = '$company' AND ( \"StartDate\" BETWEEN '$startMonthDay' AND '$endMonthDay' ) AND \"Cancel\"='FALSE' ORDER BY \"StartDate\" ASC");
...
<?php
    if($rows > 0){
        echo "<div align=\"right\"><a href=\"frm_notice_force_month_print.php?yy=$yy&mm=$mm\" target=\"_blank\"><img src=\"icoPrint.png\" border=\"0\" width=\"17\" height=\"14\" alt=\"\"> <b>สั่งพิมพ์</b></a></div>";
    }
?>
</div>
		</td>
