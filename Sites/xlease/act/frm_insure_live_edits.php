...
$insuser = pg_escape_string($_POST['insuser']);//
 ...
 //===================== OLD DATA =========================//
$qry_in=pg_query("select * from insure.\"InsureLive\" WHERE (\"InsLIDNO\"='$InsLIDNO')");
...
(\"id\",\"do_date\",\"marker_id\",\"type\",\"InsID\",\"Company\",\"StartDate\",\"EndDate\",\"Code\",\"Invest\",\"Premium\",\"Discount\",\"CollectCus\",\"InsUser\") values 
('$InsLIDNO','$nowdate','$user_id','O','$o_TempInsID','$o_Company','$o_StartDate','$o_EndDate','$o_Term','$o_Invest','$o_Premium','$o_Discount','$o_CollectCus','$o_InsUser')";
...
<br><br>
<input type="button" value="  Back  " onclick="location.href='frm_insure_live_edit.php'">
