...
<fieldset><legend><B>ประกันภัยภาคบังคับ (พรบ.) - ยกเลิกกรมธรรม์</B></legend>

<form name="search" method="post" action="">
    <input name="h_arti_id" type="hidden" id="h_arti_id" value="<?php echo pg_escape_string($_POST['h_arti_id']); ?>" />
    <b>ค้นหาเลขกรมธรรม์</b> : <input type="text" id="car_id" name="car_id" size="60" value="<?php echo pg_escape_string($_POST['h_arti_id']); ?>">
...
if($res_ct=pg_fetch_array($qry_ct)){
    ...
    $c_com=pg_query("select \"insure\".outstanding_insforce('$InsFIDNO')");
    $res_comms=pg_fetch_result($c_com,0);

?>

<form id="frm_1" name="frm_1" method="post" action="frm_cancel_force_ok.php">
<input name="insid" type="hidden" value="<?php echo "$InsFIDNO"; ?>" />
...
<table width="100%" border="0" cellSpacing="0" cellPadding="8" align="left">
    <tr align="left">
      ...
      <td width="30%"><a href="../up/frm_show.php?id=<?php echo $InsFIDNO; ?>&type=insfo&mode=1" target="_blank"><u><?php echo $InsFIDNO; ?></u></a></td>
      <td width="20%"><b>เลขที่กรมธรรม์</b></td>
      <td width="30%"><?php echo $InsID; ?></td>
   </tr>
   <tr align="left">
      <td><b>ชื่อ/สกุล</b></td>
   ...
   <tr align="left">
      <td><b>เลขถัง</b></td>
      <td><a href="../up/frm_show.php?id=<?php echo $car_num; ?>&type=reg&mode=2" target="_blank"><u><?php echo $car_num; ?></u></a></td>
...
function make_autocom(autoObj,showObj){
    ...
    new Autocomplete(mkAutoObj, function() {
        ...
        if ( this.value.length < 1 && this.isNotClick ) 
            return ;    
        return "gdata_force_cancel.php?q=" + this.value;
    });    
}    
