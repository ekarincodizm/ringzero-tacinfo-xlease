...
$qry_in=pg_query("select * from \"insure\".\"InsureLive\" WHERE (\"InsLIDNO\"='".pg_escape_string($_POST[h_arti_id])."')");
...
<fieldset><legend><B>แก้ไขประกันภัยคุ้มครองหนี้</B></legend>
<?php
if($error == 1){
...
if(isset($_POST[h_arti_id])){
?>
<form name="insureforce" method="post" action="frm_insure_live_edits.php" onsubmit="return validate(this)">
<table width="100%" border="0" cellSpacing="0" cellPadding="8" align="left">
   <tr align="left">
      <td width="20%"><b>รหัสประกัน</b></td>
      <td width="80%" colspan="3" class="text_gray"><a href="../up/frm_show.php?id=<?php echo $InsLIDNO; ?>&type=insuf&mode=1" target="_blank"><u><?php echo $InsLIDNO; ?></u></a></td>
   </tr>
   <tr align="left">
...
<?php 
$qry_inf=pg_query("select * from \"insure\".\"InsureInfo\" where \"CoCode\" like 'R%' or \"InsCompany\" like 'R%' ORDER BY \"InsCompany\" ASC");
...
?>   
   ...
   <tr align="left">
      <td><b>จำนวนงวด</b></td>
      <td colspan="3"><input type="text" name="term" size="15" maxlength="50" value="<?php echo $term; ?>">      
      </td>
   </tr>
   <tr align="left">
...
function make_autocom(autoObj,showObj){
    ...
    new Autocomplete(mkAutoObj, function() {
        ...
        if ( this.value.length < 1 && this.isNotClick ) 
            return ;    
        return "gdata_live.php?q=" + this.value;
    });    
}    
