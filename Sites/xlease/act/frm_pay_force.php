...
$(document).ready(function(){
    $("#com").change(function(){
        ...
        $("#divdate").load('frm_pay_force_process.php?type=getdate&com='+ $("#com").val());
    });
    $("#btnshow").click(function(){
        $("#divshow").html('<img src="../images/progress.gif" border="0" width="32" height="32" alt="กำลังโหลด...">');
        $("#divshow").load('frm_pay_force_show.php?com='+ $("#com").val() +'&date='+ $("#date").val());
    });
});
</script>
...
<?php
$qry=pg_query("SELECT \"Company\" FROM insure.\"VListForcePayBy\" GROUP BY \"Company\" ORDER BY \"Company\" ASC ");
