...
<fieldset><legend><a href="frm_maker.php"><B>Maker</a> > ประกันภัยภาคสมัครใจ - ยกเลิกรายการ</B></legend>

<div align="right">
<form name="frm_fuc1" method="post" action="frm_maker_select_unforce_edit.php">
เลือกบริษัทประกัน 
...
<form name="frm_2" id="frm_2" method="post" action="frm_maker_select_unforce_updates.php" onsubmit="return CheckSelect(document.frm_2.cid);">    
