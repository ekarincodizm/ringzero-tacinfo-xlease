...
<fieldset><legend><a href="frm_maker.php"><B>Maker</a> > ประกันภัยภาคสมัครใจ - เลือกรายการ</B></legend>

<div align="right">
<form name="frm_fuc1" method="post" action="frm_maker_select_unforce.php">
เลือกบริษัทประกัน 
...
<form name="frm_2" id="frm_2" method="post" action="frm_maker_select_unforce_update.php">    
<input type="hidden" name="comp" id="comp" value="<?php echo pg_escape_string($_POST['company']); ?>">
<?php
if( isset($_POST['company']) ){
    $qry_if=pg_query("select * from \"insure\".\"InsureUnforce\" WHERE \"Company\"='".pg_escape_string($_POST[company])."' AND \"Cancel\"='FALSE' AND \"CoPayInsReady\"='FALSE' AND (\"CoPayInsID\" is null OR \"CoPayInsID\" = '') ORDER BY \"InsID\" ASC");
...
?>
        <td align="center"><input type="checkbox" id="cid" name="cid[]" value="<?php echo "$InsUFIDNO"; ?>"></td>
...
<table>
    <tr bgcolor="#FFFFFF">
        <td align="center" colspan="10"><br><input name="button1" id="button1" type="button" value="ยืนยันการชำระ"></td>
    </tr>
</table>
<?php
}
