...
<div style="float:left"><input type="button" name="btnclose" id="btnclose" value="ประกันภัยภาคบังคับ (พรบ.)" onclick="javascript:window.location='frm_insure_expire_force.php' "><input type="button" name="btnclose" id="btnclose" value="ประกันภัยภาคสมัครใจ" onclick="javascript:window.location='frm_insure_expire.php' " disabled></div>
<div style="float:right"><input type="button" name="btnclose" id="btnclose" value="Close" onclick="javascript:window.close()"></div>
<div style="clear:both"></div>

<fieldset><legend><b>กรมธรรม์หมดอายุ - ประกันภัยภาคสมัครใจ</b></legend>
...
<form name="frm_2" id="frm_2" method="post" action="frm_insure_expire_letter.php" onsubmit="return CheckSelect(document.frm_2.cid);">    
...
if( isset($_POST['mm']) AND isset($_POST['yy']) ){
    ...
    $qry_if=pg_query("select * from \"insure\".\"InsureUnforce\" WHERE EXTRACT(MONTH FROM \"EndDate\")='$mm' AND EXTRACT(YEAR FROM \"EndDate\")='$yy' AND \"Cancel\"='FALSE'
     ORDER BY \"Company\",\"EndDate\",\"InsUFIDNO\" ASC");
...
?>
        <td align="center"><?php echo "$InsUFIDNO"; ?></td>
        ...
        <!--<td align="left"><?php echo "$dtl_ads"; ?></td>-->
        <td align="center"><input type="checkbox" id="cid" name="cid[]" value="<?php echo "$InsUFIDNO"; ?>" onclick="selectDisable(document.frm_2.cid);"></td>
    </tr>
<?php        
    }
    if($rows == 0){
...
?>
    ...
    <tr>
        ...
        <td align="center" width="100"><a href="frm_insure_expire_pdf.php?yy=<?php echo $yy; ?>&mm=<?php echo $mm; ?>" target="_blank"><img src="icoPrint.png" border="0" width="17" height="14" alt=""> <b>พิมพ์หน้านี้</b></a></td>
        <td colspan="6"></td>
