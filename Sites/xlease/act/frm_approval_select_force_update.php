...
$in_sql3="UPDATE \"insure\".\"InsureForce\" SET \"CoPayInsReady\"='TRUE' WHERE \"CoPayInsID\"='$CoPayInsID' ";
...
if($status == 0){
	//ACTIONLOG
		$sqlaction = pg_query("INSERT INTO action_log(id_user, action_desc, action_time) VALUES ('$get_id_user', '(TAL) อนุมัติประกันภัย พรบ.', '$datelog')");
	//ACTIONLOG---
    pg_query("COMMIT");
...
<br><br>
<input type="button" value="  Back  " onclick="location.href='frm_approval_select_force.php'">
