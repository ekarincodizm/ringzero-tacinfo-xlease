...
<form name="frm1" id="frm1" action="old_receipt_live_otherpay_update.php" method="post">
...
<?php
//หารหัสประกันภัยคุ้มครองหนี้
$typeID=pg_getinsurelivetype();
$query=pg_query("select * from \"FOtherpay\" WHERE \"IDNO\"='$idno' AND \"O_Type\"='$typeID' ORDER BY \"O_DATE\" ASC");
