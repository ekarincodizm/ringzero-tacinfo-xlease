...
<fieldset><legend><a href="frm_maker.php"><B>Maker</a> > ประกันภัยภาคบังคับ (พรบ.) - แสดงรายการ</B></legend>

<div align="right">
<form name="frm_fuc1" method="post" action="frm_maker_select_force_show.php">
เลือกบริษัทประกัน 
...
if($rows > 0){
?>
<form name="frm_remark1" method="post" action="frm_maker_select_force_update_remark.php">
...
<?php
    echo "<div align=\"right\"><br><a href=\"frm_maker_select_force_print.php?company=$company\" target=\"_blank\"><img src=\"icoPrint.png\" border=\"0\" width=\"17\" height=\"14\" alt=\"\"> <b>สั่งพิมพ์</b></a></div>";
}
?>
</div>
