...
$qry_ct=pg_query("select \"full_name\",\"C_CARNUM\",\"C_REGIS\",\"CusID\",\"asset_id\",\"C_COLOR\",\"C_CARNAME\"     from \"VContact\" WHERE (\"IDNO\"='".pg_escape_string($_POST[h_arti_id])."')");   
...
<fieldset><legend><B>เพิ่มข้อมูลประกันภัยคุ้มครองหนี้ - ลูกค้ามีสัญญาเช่าซื้อ</B></legend>

<form name="search" method="post" action="" onsubmit="return validate2(this)">
<table width="100%" border="0" cellSpacing="0" cellPadding="5" align="center">
    <tr align="center">
      <td width="20%"><b>เลขที่สัญญา, เลขตัวถัง , ชื่อผู้เช่า</b>
...
<form name="insureforce" method="post" action="frm_insure_live_add.php" onsubmit="return checkdata();">
...
<?php 
$qry_inf=pg_query("select \"InsCompany\",\"InsFullName\" from \"insure\".\"InsureInfo\" where \"CoCode\" like 'R955%' order by \"InsCompany\" asc");
...
?>      
   ...
   <tr align="left">
      <td><b>จำนวนงวด</b></td>
      <td colspan="3"><input type="text" id="term" name="term" size="15" maxlength="50">      
      </td>
   </tr>
   <tr align="left">
