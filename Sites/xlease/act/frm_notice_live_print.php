...
$gmm=iconv('UTF-8','windows-874',"ประกันภัยคุ้มครองหนี้ - ประจำวันที่ ".$restrn);
$pdf->Text(6,26,$gmm);
...
while($res_inf=pg_fetch_array($qry_inf)){
    ...
    $summary = 0;
    $qry_if=pg_query("select \"Company\", \"IDNO\", \"StartDate\", \"InsLIDNO\", \"InsID\", \"Premium\", \"EndDate\" from \"insure\".\"InsureLive\" WHERE \"Company\" = '$company' AND \"ConfirmDate\" = '$gdate' AND \"Cancel\"='FALSE' ORDER BY \"InsID\" ASC");
