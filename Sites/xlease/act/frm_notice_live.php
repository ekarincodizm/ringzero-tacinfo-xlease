...
while($res_inf=pg_fetch_array($qry_inf)){
    ...
    $summary = 0;
    $qry_if=pg_query("select \"Company\", \"IDNO\", \"StartDate\", \"InsLIDNO\", \"InsID\", \"Premium\", \"EndDate\", \"TempInsID\" from \"insure\".\"InsureLive\" WHERE \"Company\" = '$company' AND \"ConfirmDate\" = '$gdate' AND \"Cancel\"='FALSE' ORDER BY \"InsID\" ASC");
...
<?php
    if($nub > 0){
        echo "<div align=\"right\"><a href=\"frm_notice_live_print.php?gdate=$gdate\" target=\"_blank\"><img src=\"icoPrint.png\" border=\"0\" width=\"17\" height=\"14\" alt=\"\"> <b>สั่งพิมพ์</b></a></div>";
    }
?>
