...
$qry_cq=pg_query("select * from insure.\"VListForcePayBy\" WHERE \"Company\"='$select_com' AND \"CQDate\"='$select_date' AND \"Cancel\"='false' ORDER BY \"IDNO\" DESC LIMIT 1 ");
...
<?php
$qry_if=pg_query("select * from insure.\"VListForcePayBy\" WHERE \"Company\"='$select_com' AND \"CQDate\"='$select_date' AND \"Cancel\"='false' ORDER BY \"IDNO\" ");
