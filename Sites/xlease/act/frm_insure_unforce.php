...
//$qry_ct=pg_query("select * from insure.\"VInsUnforceDetail\" WHERE (\"IDNO\"='".pg_escape_string($_POST[h_arti_id])."')");
...
<fieldset><legend><B>เพิ่มข้อมูลประกันภัยภาคสมัครใจ - ลูกค้ามีสัญญาเช่าซื้อ</B></legend>
