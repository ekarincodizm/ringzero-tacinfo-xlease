...
<fieldset><legend><a href="frm_edit.php"><b>แก้ไขข้อมูล</a> > ค้นหาประกันภัยภาคสมัครใจ</b></legend>
<form name="search" method="post" action="frm_insure_unforce_edit.php" onsubmit="return validate(this)">
<table width="100%" border="0" cellSpacing="0" cellPadding="5" align="left">
    <tr align="left">
      ...
      <td width="80%" align="left" colspan="3">
        ...
        <input type="text" id="car_id" name="car_id" size="67"> <span  class="text_gray">เลขรับแจ้ง, รหัสประกัน, ชื่อผู้เช่า</span>
      </td>
   </tr>
   <tr><td><br></td></tr>
</table>
