...
$qry_ct=pg_query("select \"full_name\",\"C_CARNUM\",\"C_REGIS\",\"CusID\",\"asset_id\",\"C_COLOR\",\"C_CARNAME\",\"C_CAR_CC\" from \"UNContact\" WHERE (\"IDNO\"='".pg_escape_string($_POST[h_arti_id])."')");
...
<fieldset><legend><B>เพิ่มข้ิอมูลประกันภัยภาคบังคับ (พรบ.) - ลูกค้านอก</B></legend>
...
<input name="date_end" id="date_end" type="text" readonly="true" size="15" value="<?php echo date('Y/m/d', strtotime('+1 year')); ?>" onchange="JavaScript:fncChangeStop(); JavaScript:doCallAjax();" style="text-align:center;"/><input name="button" type="button" onclick="displayCalendar(document.insureforce.date_end,'yyyy/mm/dd',this)" value="ปฏิทิน" />      
   ...
   <tr align="left">
      <td><b>ขนาดเครื่องยนต์</b></td>
      <td colspan="3"><input type="text" name="capa" size="15" value="<?php echo $txtcapa;?>"></td>
   </tr>
   <tr align="left">
      <td><b>ส่วนลด</b></td>
