...
for($i=0;$i<count($cid);$i++){
    $in_sql="UPDATE \"insure\".\"InsureUnforce\" SET \"Commision\"=0,\"CoPayInsAmt\"=0,\"CoPayInsID\"=NULL WHERE \"InsUFIDNO\"='$cid[$i]' ";
...
<br><br>
<input type="button" value="  Back  " onclick="location.href='frm_maker_select_unforce_edit.php'">
