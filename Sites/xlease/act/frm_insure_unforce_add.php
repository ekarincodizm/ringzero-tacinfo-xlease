...
<?php
$in_sql = "insert into \"insure\".\"InsureUnforce\" (\"InsUFIDNO\",\"IDNO\",\"CusID\",\"CarID\",\"TempInsID\",\"Company\",\"StartDate\",\"EndDate\",\"Code\",\"Kind\",\"Invest\",\"Premium\",\"ConfirmDate\",\"Discount\",\"CollectCus\",\"InsUser\") values  ('$res_oins','$idno','$cusid','$asset_id','$tempinsid','$company','$date_start','$date_end','$code','$kind','$invest','$premium','$nowdate','$discount','$collectcus','$insuser')";
if($result=pg_query($in_sql)){
		
    pg_query("COMMIT");
	//ACTIONLOG
			$sqlaction = pg_query("INSERT INTO action_log(id_user, action_desc, action_time) VALUES ('$get_id_user', '(TAL) เพิ่มข้อมูลประกันภัยสมัครใจ', '$datelog')");
		//ACTIONLOG---
