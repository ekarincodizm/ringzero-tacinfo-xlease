...
<tr>
    <td>        
		...
		<fieldset><legend><B>ตัดใบเสร็จประกันเก่า-ภาคสมัครใจ</B></legend>
		<div align="center">
			<div class="ui-widget">
				...
				<?php
				$query=pg_query("select * from insure.\"VInsUnforceDetail\" WHERE \"outstanding\"<>'0' ORDER BY \"IDNO\" ASC");
				while($resvc=pg_fetch_array($query)){
					$InsUFIDNO = $resvc['InsUFIDNO'];
					$IDNO = $resvc['IDNO'];
				...
				?>
					...
					<td align="center"><input type="button" name="btn1" value="ทำรายการนี้" onclick="window.location='old_receipt_uf_otherpay.php?idno=<?php echo $IDNO; ?>&id=<?php echo $InsUFIDNO; ?>';"></td>
				</tr> 
				<?php
				}
				?>
