...
$i = 1;
$j = 0;                           
$qry_if=pg_query("select * from \"insure\".\"InsureUnforce\" WHERE \"Company\"='$company' AND \"Cancel\"='FALSE' AND \"CoPayInsReady\"='FALSE' AND \"CoPayInsID\" is not null ORDER BY \"InsID\" ASC");
