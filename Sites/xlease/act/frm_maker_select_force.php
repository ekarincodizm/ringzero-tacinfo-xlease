...
<fieldset><legend><a href="frm_maker.php"><B>Maker</a> > ประกันภัยภาคบังคับ (พรบ.) - เลือกรายการ</B></legend>


<div align="right">
<form name="frm_fuc1" method="post" action="frm_maker_select_force.php">
เลือกบริษัทประกัน 
...
<form name="frm_2" id="frm_2" method="post" action="frm_maker_select_force_update.php" onsubmit="return CheckSelect();">    
<input type="hidden" name="comp" id="comp" value="<?php echo pg_escape_string($_POST['company']); ?>">
<?php
if( isset($_POST['company']) ){
    $qry_if=pg_query("select * from \"insure\".\"InsureForce\" WHERE \"Company\"='".pg_escape_string($_POST[company])."' AND \"Cancel\"='FALSE' AND \"CoPayInsReady\"='FALSE' AND (\"CoPayInsID\" is null OR \"CoPayInsID\" = '') ORDER BY \"InsID\" ASC");
